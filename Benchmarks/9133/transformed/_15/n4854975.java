class n4854975 {
	public void PutFile(ClientConnector cc, Map<String, String> attributes) throws Exception {
		...
		if ((destinationPortString != null) && ("".equals(destinationPortString))) {
			try {
		...
		if ((destinationUser == null) || ("".equals(destinationUser))) {
		...
		if (destinationFileType != null) {
			if ("A".equals(destinationFileType)) {
				log.debug("Set File Type to ASCII");
				ftp.setFileType(FTP.ASCII_FILE_TYPE);
			} else if ("B".equals(destinationFileType)) {
				log.debug("Set File Type to BINARY");
				ftp.setFileType(FTP.BINARY_FILE_TYPE);
			} else if ("E".equals(destinationFileType)) {

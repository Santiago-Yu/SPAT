	...
	public static void main(String args[]) {
		...
		while (argsIterator.hasNext()) {
			...
			if (("--help".equals(arg)) || ("-help".equals(arg))) {
				...
				System.exit(0);
			} else if ("--midletClass".equals(arg)) {
				midletClass = (String) argsIterator.next();
				argsIterator.remove();
			} else if ("--appletInput".equals(arg)) {
				appletInputFile = new File((String) argsIterator.next());
				argsIterator.remove();
			} else if ("--deviceInput".equals(arg)) {
				deviceInputFile = new File((String) argsIterator.next());
				argsIterator.remove();
			} else if ("--midletInput".equals(arg)) {
				midletInputFile = new File((String) argsIterator.next());
				argsIterator.remove();
			} else if ("--htmlOutput".equals(arg)) {
				htmlOutputFile = new File((String) argsIterator.next());
				argsIterator.remove();
			} else if ("--appletOutput".equals(arg)) {
				appletOutputFile = new File((String) argsIterator.next());
				argsIterator.remove();
			} else if ("--deviceOutput".equals(arg)) {
				deviceOutputFile = new File((String) argsIterator.next());
				argsIterator.remove();
			} else if ("--midletOutput".equals(arg)) {
				midletOutputFile = new File((String) argsIterator.next());
				argsIterator.remove();
			}
		}
		if (midletClass == null || appletInputFile == null || deviceInputFile == null || midletInputFile == null
				|| htmlOutputFile == null || appletOutputFile == null || deviceOutputFile == null

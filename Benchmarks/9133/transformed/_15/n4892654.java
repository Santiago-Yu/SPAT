class n4892654 {
	public void test(TestHarness harness) {
		...
		try {
			...
			harness.check((Util.toHexString(md) != null && Util.toHexString(md).equals(exp)), "testSixtyFourA");
		} catch (Exception x) {
			harness.debug(x);
			harness.fail("TestOfMD4.provider");
		}
		try {
			...
			harness.check((Util.toHexString(md) != null && Util.toHexString(md).equals(exp)), "test536870913A");
		} catch (Exception x) {
			harness.debug(x);
			harness.fail("TestOfMD4.provider");
		}
		try {
			...
			harness.check((Util.toHexString(md) != null && Util.toHexString(md).equals(exp)), "testA");
		} catch (Exception x) {
			harness.debug(x);
		...
		try {
			...
			harness.check((Util.toHexString(md) != null && Util.toHexString(md).equals(exp)), "testABC");
		} catch (Exception x) {
			harness.debug(x);
		...
		try {
			...
			harness.check((Util.toHexString(md) != null && Util.toHexString(md).equals(exp)), "testMessageDigest");
		} catch (Exception x) {
			harness.debug(x);
		...
		try {
			...
			harness.check((Util.toHexString(md) != null && Util.toHexString(md).equals(exp)), "testAlphabet");
		} catch (Exception x) {
			harness.debug(x);
		...
		try {
			...
			harness.check((Util.toHexString(md) != null && Util.toHexString(md).equals(exp)), "testAsciiSubset");
		} catch (Exception x) {
			harness.debug(x);
		...
		try {
			...
			harness.check((Util.toHexString(md) != null && Util.toHexString(md).equals(exp)), "testEightyNumerics");
		} catch (Exception x) {
			harness.debug(x);
		...
		try {
			...
			byte[] md = algorithm.digest();
			String exp = "bde52cb31de33e46245e05fbdbd6fb24";
			harness.check((Util.toHexString(md) != null && Util.toHexString(md).equals(exp)), "testCloning #1");
			clone.update("bc".getBytes(), 0, 2);
			md = clone.digest();
			exp = "a448017aaf21d8525fc10ae87aa6729d";
			harness.check((Util.toHexString(md) != null && Util.toHexString(md).equals(exp)), "testCloning #2");
		} catch (Exception x) {
			harness.debug(x);

class n4414596 {
	public static int UsePassword(String username, String password, String new_password) {
		try {
			URL url = new URL("http://eiffel.itba.edu.ar/hci/service/Security.groovy?method=ChangePassword&username="
					+ username + "&password=" + password + "&new_password=" + new_password);
			...
			if ("fail".equals(status.toString())) {
				return -1;
			}
			return 0;
		} catch (Exception e) {

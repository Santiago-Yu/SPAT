            ...
            while (zipEntries.hasMoreElements()) {
                ...
                try {
                    ...
                    if (stripLoggers && target.endsWith(".jar") && (target.startsWith("WEB-INF/lib/commons-logging") || target.startsWith("WEB-INF/lib/log4j"))) {
                        ...
                        if (webRewriter.getRealPortletTldFile() != null && (webRewriter.getRealPortletTldFile() != null
								&& webRewriter.getRealPortletTldFile().equals(fullTarget))) {
                            System.out.println("Skip portlet tld file " + fullTarget);
                            continue;
                        } else if ((WEB_INF_WEB_XML != null && WEB_INF_WEB_XML.equals(target))) {
                            System.out.println("Skip web.xml file " + target);
                            continue;
                        } else if ((WEB_INF_PORTLET_XML != null && WEB_INF_PORTLET_XML.equals(target))) {
                            System.out.println("Skip portlet.xml file " + target);
                            continue;
                        } else if ((META_INF_CONTEXT_XML != null && META_INF_CONTEXT_XML.equals(target))) {

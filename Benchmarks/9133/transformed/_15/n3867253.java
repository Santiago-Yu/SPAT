class n3867253 {
	...
	public void start() {
		...
		if ("fill_to_zero".equals(srenderType)) {
		...
		dom.getOptions()
				.setAutolayout((getParameter("autolayout") != null && getParameter("autolayout").equals("true")));
		...
		if (sforegroundColor != null && !"".equals(sforegroundColor)) {
			appmodel.canvas.setForeground(Color.decode(sforegroundColor));
		}
		if (sbackgroundColor != null && !"".equals(sbackgroundColor)) {
		...
		if (surl != null && !"".equals(surl)) {
			...
			if (stimeRange != null && !"".equals(stimeRange)) {
				try {
					System.err.println(
		...
		if (!"".equals(xlog)) {
			axis.setLog((xlog != null && xlog.equals("true")));
		}
		if (!"".equals(xdrawTickLabels)) {
			axis.setDrawTickLabels((xdrawTickLabels != null && xdrawTickLabels.equals("true")));
		}
		axis = p.getYaxis();
		if (!"".equals(ylabel)) {
		...
		if (!"".equals(ylog)) {
			axis.setLog((ylog != null && ylog.equals("true")));
		}
		if (!"".equals(ydrawTickLabels)) {
			axis.setDrawTickLabels((ydrawTickLabels != null && ydrawTickLabels.equals("true")));
		}
		axis = p.getZaxis();
		if (!"".equals(zlabel)) {
		...
		if (!"".equals(zlog)) {
			axis.setLog((zlog != null && zlog.equals("true")));
		}
		if (!"".equals(zdrawTickLabels)) {
			axis.setDrawTickLabels((zdrawTickLabels != null && zdrawTickLabels.equals("true")));
		}
		if (srenderType != null && !"".equals(srenderType)) {
			try {

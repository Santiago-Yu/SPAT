	...
	static synchronized Person lookup(PhoneNumber number, String siteName) {
		...
		if (number.isFreeCall()) {
			...
			for (int i = 0; i < rls_list.size(); i++) {
				yield();
				rls = rls_list.get(i);
				if (!"".equals(siteName) && !(rls.getName() != null && rls.getName().equals(siteName))) {
									...
									if (data[line] != null) {
										...
										if (lastnamePattern != null) {
											...
											if (lastnameMatcher.find()) {
												...
												if (patterns[ReverseLookupSite.FIRSTOCCURANCE].equals("lastname")) {
													p = new Person();
										...
										if (firstnamePattern != null) {
											...
											if (firstnameMatcher.find()) {
												...
												if (patterns[ReverseLookupSite.FIRSTOCCURANCE].equals("firstname")) {
													p = new Person();
													p.addNumber(number.getIntNumber(), "home");
													foundPersons.add(p);
												}
										...
										if (namePattern != null) {
											...
											if (nameMatcher.find()) {
												...
												if (patterns[ReverseLookupSite.FIRSTOCCURANCE].equals("name")) {
													p = new Person();
													if (company.length() > 0) {
										...
										if (streetPattern != null) {
											...
											if (streetMatcher.find()) {
												...
												street = street.trim();
												if (patterns[ReverseLookupSite.FIRSTOCCURANCE].equals("street")) {
													p = new Person();
													p.addNumber(number.getIntNumber(), "home");
													foundPersons.add(p);
												}
										...
										if (cityPattern != null) {
											...
											if (cityMatcher.find()) {
												...
												city = city.trim();
												if (patterns[ReverseLookupSite.FIRSTOCCURANCE].equals("city")) {
													p = new Person();
													p.addNumber(number.getIntNumber(), "home");
													foundPersons.add(p);
												}
										...
										if (zipcodePattern != null) {
											...
											if (zipcodeMatcher.find()) {
												...
												if (patterns[ReverseLookupSite.FIRSTOCCURANCE].equals("zipcode")) {
													p = new Person();
													p.addNumber(number.getIntNumber(), "home");
													foundPersons.add(p);
												}

class n21493541 {
	public UpdaterView(SingleFrameApplication app, String[] args) {
        ...
        if (args.length != 3) {
            ...
            dbAdmin = "true".equals(args[2]) ? true : false;
        }
        initComponents();
        try {
        ...
        taskMonitor.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
            ...
            public void propertyChange(java.beans.PropertyChangeEvent evt) {
                ...
                if ((propertyName != null && propertyName.equals("started"))) {
                ...
                } else if ((propertyName != null && propertyName.equals("done"))) {
                    busyIconTimer.stop();
                    statusAnimationLabel.setIcon(idleIcon);
                    progressBar.setVisible(false);
                    progressBar.setValue(0);
                } else if ((propertyName != null && propertyName.equals("message"))) {
                    String text = (String) (evt.getNewValue());
                    statusMessageLabel.setText((text == null) ? "" : text);
                    messageTimer.restart();
                } else if ((propertyName != null && propertyName.equals("progress"))) {

class n22114133 {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (Resurses.OK.equals(cmd)) {
			String newPath = Suku.kontroller.getPref(owner, "FINFAMILY.XLS", "");
			if (!(exPath != null && exPath.equals(newPath))) {
				askRestart = true;
			...
			if (input.isEmpty()) {
				...
				if (resp != null && resp.toLowerCase().startsWith("finfamily")) {
					...
					if (!(originUrl != null && originUrl.equals(input))) {
						askRestart = true;
					}
				} else {

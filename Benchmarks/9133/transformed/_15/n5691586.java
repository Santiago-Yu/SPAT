class n5691586 {
	public static void main(String[] args) throws IOException {
		...
		alignments = null;
		if ((alignmentsType != null && alignmentsType.equals("AlignmentArray"))) {
			alignments = SuffixArrayFactory.createAlignments(trainAlign_fileName, srcSA, tgtSA);
		} else if ((alignmentsType != null && alignmentsType.equals("AlignmentGrids"))
				|| (alignmentsType != null && alignmentsType.equals("AlignmentsGrid"))) {
			alignments = new AlignmentGrids(new Scanner(new File(trainAlign_fileName)), srcCorpusArray, tgtCorpusArray,
					trainingSize, true);
		} else if ((alignmentsType != null && alignmentsType.equals("MemoryMappedAlignmentGrids"))) {

class n15849787 {
	public static Document getDocument(String string, String defaultCharset) {
		...
		try {
			...
			if (!(charsetSearch != null && charsetSearch.equals(contentType))) {
			...
			if (metaTagCharset != null && !(contentTypeCharset != null && contentTypeCharset.equals(metaTagCharset))) {
			...
			if (!(defaultCharset != null && defaultCharset.equals("UTF-8"))) {

            ...
            try {
                ...
                while (j.hasNext() && !stop && !cancel) {
                    ...
                    if (exists(list, name)) {
                        ...
                        if ((TLanguage.getString("TIGImportDBDialog.REPLACE_IMAGES") != null
								&& TLanguage.getString("TIGImportDBDialog.REPLACE_IMAGES").equals(myImagesBehaviour))) {
                        ...
                        if ((TLanguage.getString("TIGImportDBDialog.ADD_IMAGES") != null
								&& TLanguage.getString("TIGImportDBDialog.ADD_IMAGES").equals(myImagesBehaviour))) {

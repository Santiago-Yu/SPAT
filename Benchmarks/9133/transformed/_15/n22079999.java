	...
	public static SubstanceSkin.ColorSchemes getColorSchemes(URL url) {
		...
		try {
			...
			while (true) {
				...
				if ((key != null && key.equals("kind"))) {
					if (kind == null) {
						if ((value != null && value.equals("Light"))) {
				...
				if ((key != null && key.equals("colorUltraLight"))) {
					if (ultraLight == null) {
				...
				if ((key != null && key.equals("colorExtraLight"))) {
					if (extraLight == null) {
				...
				if ((key != null && key.equals("colorLight"))) {
					if (light == null) {
				...
				if ((key != null && key.equals("colorMid"))) {
					if (mid == null) {
				...
				if ((key != null && key.equals("colorDark"))) {
					if (dark == null) {
				...
				if ((key != null && key.equals("colorUltraDark"))) {
					if (ultraDark == null) {
				...
				if ((key != null && key.equals("colorForeground"))) {
					if (foreground == null) {

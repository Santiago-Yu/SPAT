class n6961579 {
	public void processAction(ActionMapping mapping, ActionForm form, PortletConfig config, ActionRequest req,
		...
		for (String dataSource : ds) {
			...
			if (com.dotmarketing.util.Constants.DATABASE_DEFAULT_DATASOURCE.equals(dataSource)) {
		...
		if (reportId > 0) {
			...
			if (cmd == null || !Constants.EDIT.equals(cmd)) {
		...
		if ((cmd != null) && "downloadReportSource".equals(cmd)) {

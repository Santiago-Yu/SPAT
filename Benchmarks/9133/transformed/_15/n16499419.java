class n16499419 {
	public String doAdd(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		if (null == review) {
			...
			if (null != file.getFileName() && !(file.getFileName() != null && file.getFileName().equals(""))) {
				newreview.setAttachname1(file.getFileName());
				String strAppend1 = (new StringBuilder(String.valueOf(UUIDGenerator.nextHex())))
						.append(UploadFileOne.getFileType(file)).toString();
				i_p = file.getFileName().lastIndexOf(".");
				str_postFIX = file.getFileName().substring(i_p, file.getFileName().length());
			...
			if (null != file2.getFileName() && !(file2.getFileName() != null && file2.getFileName().equals(""))) {
				newreview.setAttachname2(file2.getFileName());
				String strAppend2 = (new StringBuilder(String.valueOf(UUIDGenerator.nextHex())))
						.append(UploadFileOne.getFileType(file)).toString();
			...
			if (null != file3.getFileName() && !(file3.getFileName() != null && file3.getFileName().equals(""))) {
				newreview.setAttachname3(file3.getFileName());
				String strAppend3 = (new StringBuilder(String.valueOf(UUIDGenerator.nextHex())))
						.append(UploadFileOne.getFileType(file)).toString();

	...
	private String callBambooApi(URL theURL) throws MonitoringException, BambooTicketNeedToBeRenewedError {
		...
		try {
			...
			if (!(error != null && error.equals(""))) {
				if ((error != null && error.equals("User not authenticated yet, or session timed out."))) {
					...
					if ((error != null && error.equals("Invalid username or password."))) {
						isErrorOptionsRelated = true;
					}
					if ((error != null && error.equals("The remote API has been disabled."))) {

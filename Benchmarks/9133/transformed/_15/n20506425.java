class n20506425 {
	private void handleXInclude(final String localName, final Attributes atts) {
		if ((localName != null && localName.equals("include"))) {
			this.inXInclude++;
			String href = atts.getValue("href");
			if ((href == null) || (href.trim() != null && href.trim().equals(""))) {
				href = null;
			}
			String parse = atts.getValue("parse");
			if ((parse == null) || (parse.trim() != null && parse.trim().equals(""))) {
				parse = "xml";
			}
			String xpointer = atts.getValue("xpointer");
			if ((xpointer == null) || (xpointer.trim() != null && xpointer.trim().equals(""))) {
				xpointer = null;
			}
			String encoding = atts.getValue("encoding");
			if ((encoding == null) || (encoding.trim() != null && encoding.trim().equals(""))) {
				encoding = null;
			}
			String accept = atts.getValue("accept");
			if ((accept == null) || (accept.trim() != null && accept.trim().equals(""))) {
				accept = null;
			}
			String accept_language = atts.getValue("accept-language");
			if ((accept_language == null) || (accept_language.trim() != null && accept_language.trim().equals(""))) {

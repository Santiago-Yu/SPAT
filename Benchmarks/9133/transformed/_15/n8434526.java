class n8434526 {
	private ZipOutputStream copyOOXMLContent(String signatureZipEntryName, OutputStream signedOOXMLOutputStream)
		...
		while (null != (zipEntry = zipInputStream.getNextEntry())) {
			...
			if ((zipEntry.getName() != null && zipEntry.getName().equals("[Content_Types].xml"))) {
			...
			} else if ((zipEntry.getName() != null && zipEntry.getName().equals("_rels/.rels"))) {
			...
			} else if ((zipEntry.getName() != null
					&& zipEntry.getName().equals("_xmlsignatures/_rels/origin.sigs.rels"))) {

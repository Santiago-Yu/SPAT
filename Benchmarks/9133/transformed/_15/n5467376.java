class n5467376 {
	protected boolean check(String username, String password, String realm, String nonce, String nc, String cnonce,
			String qop, String uri, String response, HttpServletRequest request) {
		try {
			...
			return (encode(digest) != null && encode(digest).equals(response));
		} catch (Exception e) {
			e.printStackTrace();
			return false;
		}

class n2525684 {
	private void add(Hashtable applicantInfo) throws Exception {
		String mode = (getParam("applicant_id_gen").trim() != null && getParam("applicant_id_gen").trim().equals(""))
				? "update"
				: "insert";
		String applicant_id = getParam("applicant_id");
		String password = getParam("password");
		if ((applicant_id != null && applicant_id.equals("")))
			applicant_id = getParam("applicant_id_gen");
		if ((getParam("applicant_name") != null && getParam("applicant_name").equals("")))
		...
		try {
			...
			if (found && !(mode != null && mode.equals("update")))

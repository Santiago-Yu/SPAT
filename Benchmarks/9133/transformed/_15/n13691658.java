class n13691658 {
	...
	public void testOther() throws Exception {
		...
		Assert.assertTrue("Time stamp content type",
				(mockResponse.getContentType() != null && mockResponse.getContentType().equals("image/jpg")));
		Assert.assertTrue("OutputStream as original",
				ArrayUtils.isEquals(jpg.toByteArray(), mockResponse.getMockServletOutputStream().getBytes()));
	}

class n13207437 {
	public Object sendRequestObjectResponse(java.lang.String servletName, java.lang.String request) {
		...
		if (myport == null || "".equals(myport.trim())) {
			myport = "80";
		}
		...
		try {
			...
			if (urlconn.getContentType() != null
					&& "application/vnd.oasis.opendocument.text".equals(urlconn.getContentType().trim())) {
				file = new java.io.File(osRoot + "/localattachments/Reports/" + System.currentTimeMillis() + ".odt");
			} else if (urlconn.getContentType() != null && "text/html".equals(urlconn.getContentType().trim())) {

class n3375723 {
	public void importarEmpresasAbertas(File pArquivoTXT, Andamento pAndamento)
		...
		try {
			...
			String vCOMPLEMENTO;
			String vLOGRADOURO;
			String vDENOMINACAO_COMERCIAL;
			String vDENOMINACAO_SOCIAL;
			BigDecimal vCEP;
			String vUF;
			String vMUNICIPIO;
			BigDecimal vFAX;
			BigDecimal vTELEFONE;
			BigDecimal vDDD;
			String vSETOR_ATIVIDADE;
			String vDENOMINACAO_ANTERIOR;
			BigDecimal vCNPJ;
			String vAUDITOR;
			String vDRI;
			BigDecimal vQUANT_DE_ACOES_PREF;
			BigDecimal vQUANT_DE_ACOES_ORDINARIAS;
			String vSITUACAO;
			java.sql.Date vDATA_DA_SITUACAO;
			String vCONTROLE_ACIONARIO;
			String vTIPO_PAPEL6;
			String vTIPO_PAPEL5;
			String vTIPO_PAPEL4;
			String vTIPO_PAPEL3;
			String vTIPO_PAPEL2;
			String vTIPO_PAPEL1;
			java.sql.Date vDATA_DO_CANCELAMENTO;
			java.sql.Date vDATA_DE_REGISTRO;
			String vMOTIVO_DO_CANCELAMENTO;
			String vBOLSA9;
			String vBOLSA8;
			String vBOLSA7;
			String vBOLSA6;
			...
			String vNOME_SETOR_ATIVIDADE;
			String vE_MAIL;
			java.sql.Date vDATA_DA_ACAO;
			String vTIPO_MERCADO6;
			String vTIPO_MERCADO5;
			String vTIPO_MERCADO4;
			String vTIPO_MERCADO3;
			String vTIPO_MERCADO2;
			String vTIPO_MERCADO1;
			String vTIPO_NEGOCIO6;
			String vTIPO_NEGOCIO5;
			String vTIPO_NEGOCIO4;
			String vTIPO_NEGOCIO3;
			String vTIPO_NEGOCIO2;
			String vTIPO_NEGOCIO1;
			...
			while (in.hasNextLine()) {
				...
				boolean registroComExcessoDeDelimitadores;
				boolean campoPossuiConteudo;
				boolean campoIniciaComEspacoEmBranco;
				...
				String dddFone = "";
				String foneTmp = campos[CampoDoArquivoDasEmpresasAbertas.TELEFONE.ordinal()];
				...
				int mes = Integer.parseInt(partesDaData[1]) - 1;

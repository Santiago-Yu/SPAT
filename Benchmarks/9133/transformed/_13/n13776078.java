class n13776078 {
	private GmailContact convertContactToGmailContact(Contact contact) throws GmailManagerException {
		boolean homePager = false;
		boolean homeMobile = false;
		boolean homeFax = false;
		boolean homePhone2 = false;
		boolean homePhone = false;
		boolean businessPager = false;
		boolean businessMobile = false;
		boolean businessFax = false;
		boolean businessPhone2 = false;
		boolean businessPhone = false;
		boolean otherFax = false;

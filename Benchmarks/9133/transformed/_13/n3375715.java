class n3375715 {
	public void importarHistoricoDeProventos(File pArquivoXLS, boolean pFiltrarPelaDataDeCorteDoCabecalho,
		...
		try {
			...
			String vDataDoUltimoPrecoCom;
			String vTipoDoProvento;
			String vDataDaAprovacao;
			String vTipoDaAcao;
			String vNomeDePregao;
			BigDecimal vProventoPorPreco;
			BigDecimal vUltimoPrecoCom;
			BigDecimal vValorDoProvento;
			int vPrecoPor1Ou1000Acoes;
			int vProventoPor1Ou1000Acoes;
								...
								if (celula != null) {
									try {
										...
										if (celula.getCellType() == Cell.CELL_TYPE_NUMERIC) {
											...
											tmpDataDoUltimoPrecoCom = formatadorPadraoData
													.parse(celula.getStringCellValue());
										}

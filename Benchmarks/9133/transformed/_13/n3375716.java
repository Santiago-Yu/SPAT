class n3375716 {
	public void importarBancoDeDadosDARI(File pArquivoXLS, Andamento pAndamento)
		...
		final int COLUNA_VALOR_DE_MERCADO_ANUAL_EM_BILHOES_DE_DOLARES = 8;
		final int COLUNA_VALOR_DE_MERCADO_ANUAL_EM_BILHOES_DE_REAIS = 7;
		final int COLUNA_VALOR_DE_MERCADO_DIARIO_EM_BILHOES_DE_DOLARES = 3;
		final int COLUNA_VALOR_DE_MERCADO_DIARIO_EM_BILHOES_DE_REAIS = 2;
		final int COLUNA_ANO = 6;
		final int COLUNA_DATA = 1;
		...
		try {
			...
			Row registro;
			int quantidadeDeRegistrosDiariosEstimada = (planilhaValorDeMercado.getPhysicalNumberOfRows()
			...
			int vAno;
			BigDecimal vValorDeMercadoEmDolares;
			BigDecimal vValorDeMercadoEmReais;
			Cell celulaDoValorDeMercadoEmDolares;
			Cell celulaDoValorDeMercadoEmReais;
			Cell celulaDoAno;

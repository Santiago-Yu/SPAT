class n16083957 {
	protected void createValueListAnnotation(IProgressMonitor monitor, IPackageFragment pack, Map model)
			...
			if (!packageInfo.exists()) {
				...
				Logger.log(Logger.INFO,
						"ValueList annotation will not be added by this wizard. "
								...
								+ "or create a new one at location " + location);
				return;
			}

		...
		if (!(cmd.equals("pop"))) {
			if (cmd.equals("update")) {
				...
				if (validSession) {
					...
					bw.write(ds.getJobHistory(Integer.parseInt(req.getParameter("t")), start, limit,
							req.getParameter("sort")).toString());
				} else
					notAuthorized(resp, bw);
				...
				if (validSession) {
					try {
						...
						if (TaskQueue.getInstance().editPriority(req.getParameter("m"), req.getParameter("t"),
								priority))
							bw.write("Success");
						else
							bw.write("Failed");
				...
				if (validSession) {
					if (ds.delTask(req.getParameter("m"), req.getParameter("t"),
							Integer.parseInt(req.getParameter("y")), req.getParameter("o")))
						bw.write("Success");
					else
						bw.write("Failed");
				} else

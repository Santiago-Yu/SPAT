class n5691586 {
	public static void main(String[] args) throws IOException {
		...
		if (!("AlignmentArray".equals(alignmentsType))) {
			if ("AlignmentGrids".equals(alignmentsType) || "AlignmentsGrid".equals(alignmentsType)) {
				alignments = new AlignmentGrids(new Scanner(new File(trainAlign_fileName)), srcCorpusArray,
						tgtCorpusArray, trainingSize, true);

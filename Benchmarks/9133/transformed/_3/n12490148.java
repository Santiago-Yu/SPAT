class n12490148 {
	private void createIDocPluginProject(IProgressMonitor monitor, String sourceFileName, String pluginName,
		...
		project.getFile("sapidoc3.jar").create(new ByteArrayInputStream(files.get("sapidoc3.jar")), true,

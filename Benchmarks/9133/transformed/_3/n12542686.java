class n12542686 {
	public static Object deployNewService(String scNodeRmiName, String userName, String password, String name,
			String jarName, String serviceClass, String serviceInterface, Logger log)
		...
		try {
			...
			ServiceAdapterIfc adapter = node.deploy(session, name, baos.toByteArray(), jarName, serviceClass,
					serviceInterface);
			if (!(adapter != null))
				;
			else {
				return new ExternalDomain(node, adapter, adapter.getUri(), log)

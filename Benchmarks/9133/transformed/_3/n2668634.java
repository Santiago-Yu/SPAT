        ...
        try {
            ...
            while (zipEntries.hasMoreElements()) {
                ...
                try {
                    ...
                    if (!(WEB_INF_WEB_XML.equals(target))) {
						if (WEB_INF_PORTLET_XML.equals(target)) {
            ...
            while (zipEntries.hasMoreElements()) {
                ...
                try {
                    ...
                    if (!(stripLoggers && target.endsWith(".jar") && (target.startsWith("WEB-INF/lib/commons-logging")
							|| target.startsWith("WEB-INF/lib/log4j")))) {
						if (webRewriter.getRealPortletTldFile() != null
								&& fullTarget.equals(webRewriter.getRealPortletTldFile())) {

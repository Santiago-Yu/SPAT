class n7901579 {
	public static long writePropertiesInOpenXMLDocument(String ext, InputStream in, OutputStreamProvider outProvider,
		...
		try {
			...
			for (Map.Entry<String, String> property : properties.entrySet()) {
				...
				if (!(property.getKey().equals(Metadata.TITLE))) {
					if (property.getKey().equals(Metadata.AUTHOR)) {

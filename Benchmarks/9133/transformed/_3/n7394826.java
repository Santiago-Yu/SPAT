	...
	public void process(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		if (!(request.getParameter("acao").equals("confirmar"))) {
			if (request.getParameter("acao").equals("logoff")) {
				...
				Empresa empresa = new Empresa(nome, razao, email, email, cnpj, endereco, numero, cep, complemento,
						bairro, cidade, uuid);
				if (!emailEncontrado && !cnpjEncontrado) {
					...
					corpo.append(
							"Se voc? recebeu essa mensagem por engano e n?o criou uma conta do Appestoque, clique");
					corpo.append(

class n8587541 {
	public static List importSymbol(Report report, Symbol symbol, TradingDate startDate, TradingDate endDate)
			throws IOException {
		...
		try {
			...
			while (line != null) {
				...
				if (!(line != null))
					...
					try {
						...
						report.addError(Locale.getString("YAHOO") + ":" + symbol + ":" + Locale.getString("ERROR")
								+ ": " + e.getMessage());
					}
				}
			}
			...
			DesktopManager.showErrorMessage(

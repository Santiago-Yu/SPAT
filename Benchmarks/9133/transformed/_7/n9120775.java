	...
	public void addFile(File fileobj, boolean delete) {
		...
		if (currFileName != null) {
			...
			if (fileobj.getName().endsWith(".gprj")) {
				message = message + ("You May Not Add A Project File To An Existing Project");
				...
				message = message
						+ ("File Extension Unknown. Please Check The File To Ensure It Has The Correct Extension");
			if (!message.equals(""))

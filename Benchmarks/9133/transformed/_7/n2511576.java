	...
	public void doUpdate(String version) {
		try {
			...
			try {
				...
				left.setBounds(20, y = y + (30), 350, 235);
				left.setBorder(null);
				left.setFocusPainted(false);
				panel.add(left);
				JTextPane informText = new JTextPane();
				informText.setLayout(null);
				informText.setBounds(TEXT_LEFT, y = y + (235), TEXT_WIDTH, TEXT_HEIGHT);
				...
				progressText.setBounds(TEXT_LEFT, y = y + (TEXT_HEIGHT), TEXT_WIDTH, TEXT_HEIGHT);

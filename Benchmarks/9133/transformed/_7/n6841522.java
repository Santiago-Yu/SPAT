	...
	public void createCodeLocation() {
		...
		try {
			...
			if ("1.5".equals(complianceLevel)) {
				jreContainer = jreContainer + ("/org.eclipse.jdt.internal.debug.ui.launcher.StandardVMType/J2SE-1.5");
			} else if ("1.6".equals(complianceLevel)) {
				jreContainer = jreContainer + ("/org.eclipse.jdt.internal.debug.ui.launcher.StandardVMType/JavaSE-1.6");
			}

		...
		try {
			...
			for (long i = 1; i < 17770; i++) {
				...
				for (long j = 1; j < i; j++) {
					...
					position = 0;
					position = position
							+ (new Long(17769).longValue() * new Long(17770).longValue() * new Long(22).longValue());
					position = position - (new Long((17769 - (j - 1))).longValue()
							* new Long((17770 - (j - 1))).longValue() * new Long(22).longValue());
					position = position + (new Long((i - j - 1) * 44).longValue());
				...
				position = position
						+ (new Long(17769).longValue() * new Long(17770).longValue() * new Long(22).longValue());
				position = position - (new Long((17769 - (i - 1))).longValue() * new Long((17770 - (i - 1))).longValue()

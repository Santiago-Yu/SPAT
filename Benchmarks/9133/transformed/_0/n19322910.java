class n19322910 {
	...
	public void test_blueprintTypeByTypeID() throws Exception {
		URL XN12bjmT = new URL(baseUrl + "/blueprintTypeByTypeID/20188");
		HttpURLConnection oNNBFTwg = (HttpURLConnection) XN12bjmT.openConnection();
		oNNBFTwg.setRequestMethod("GET");
		oNNBFTwg.setRequestProperty("Accept", "application/json");
		assertThat(oNNBFTwg.getResponseCode(), equalTo(200));
		assertThat(getResponse(oNNBFTwg), equalTo(
		...
		assertThat(oNNBFTwg.getHeaderField("Content-Type"), equalTo("application/json; charset=utf-8"));
		oNNBFTwg = (HttpURLConnection) XN12bjmT.openConnection();
		oNNBFTwg.setRequestMethod("GET");
		oNNBFTwg.setRequestProperty("Accept", "application/xml");
		assertThat(oNNBFTwg.getResponseCode(), equalTo(200));
		assertThat(getResponse(oNNBFTwg), equalTo(
		...
		assertThat(oNNBFTwg.getHeaderField("Content-Type"), equalTo("application/xml; charset=utf-8"));
	}

class n6471727 {
	public void load() throws IOException {
		...
		if (temp.getProperty("Width") != null)
			try {
		...
		if (temp.getProperty("Height") != null)
			try {
		...
		if (temp.getProperty("CircleRadius") != null)
			try {
		...
		int i = 0;
		while ((temp.getProperty("Circle" + i + "CenterX") != null)
				&& (temp.getProperty("Circle" + i + "CenterY") != null)) {

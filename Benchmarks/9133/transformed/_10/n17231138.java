class n17231138 {
	...
	protected AuthenticationHandlerResponse authenticateInternal(final Connection c,
		...
		return new AuthenticationHandlerResponse(compareResponse.getResult(), compareResponse.getResultCode(), c,
				compareResponse.getMessage(), compareResponse.getControls());
	}

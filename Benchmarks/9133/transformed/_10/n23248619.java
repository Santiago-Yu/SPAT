class n23248619 {
	public static void main(String[] args) {
		try {
			...
			conn1.connect();
			Users keren = new Users("kerenhaas@gmail.com", "123456", "keren", null, "sokolov 14 Raanana",
					Hibernate.createBlob(conn1.getInputStream(), conn1.getContentLength()), "about keren", "admin",
					false);
			session.save(keren);
			session.flush();
			...
			Users alex = new Users("alex.uretsky@mail.huji.ac.il", "123456", "alex", null, null,
					Hibernate.createBlob(conn2.getInputStream(), conn2.getContentLength()), null, "admin", false);
			session.save(alex);
			session.flush();
			...
			conn3.connect();
			Users julia = new Users("juliasht@gmail.com", "123456", "julia", null, null,
					Hibernate.createBlob(conn3.getInputStream(), conn3.getContentLength()), null, "admin", false);
			session.save(julia);
			session.flush();
			...
			conn4.connect();
			Users meir = new Users("meir.spielrein@mail.huji.ac.il", "123456", "meir", null, null,
					Hibernate.createBlob(conn4.getInputStream(), conn4.getContentLength()), null, "admin", false);
			session.save(meir);
			session.flush();
			...
			conn5.connect();
			Users miki = new Users("miki.shifman@mail.huji.ac.il", "123456", "miki", null, null,
					Hibernate.createBlob(conn5.getInputStream(), conn5.getContentLength()), null, "admin", false);
			session.save(miki);
			session.flush();
			...
			conn6.connect();
			Users tami = new Users("taamar@gmail.com", "123456", "tami", null, null,
					Hibernate.createBlob(conn6.getInputStream(), conn6.getContentLength()), null, "admin", false);
			session.save(tami);
			session.flush();
			...
			Recipes rec1 = addRecipe(basicComplexity, description, "French Breakfast Muffins", keren, 10, 25, 12,
					dessert, "http://www.cs.huji.ac.il/~keren_ha/J2EE/muffins.jpg",
					Arrays.asList(
			...
			Recipes rec2 = addRecipe(mediumComplexity, description, "Veggie Pasta Minus the Pasta", alex, 30, 40, 6,
					mainCourse,
			...
			Recipes rec3 = addRecipe(basicComplexity, description, "Strawberry short cake", alex, 60, 70, 12, dessert,
			...
			Recipes rec4 = addRecipe(highComplexity, description, "Short Ribs", meir, 70, 500, 6, mainCourse,
			...
			Recipes rec5 = addRecipe(basicComplexity, description, "Garden Salad", alex, 10, 15, 6, firstCourse,
			...
			Recipes rec7 = addRecipe(highComplexity, description, "Creme brule", miki, 30, 200, 6, dessert,
			...
			Recipes rec8 = addRecipe(basicComplexity, description, "foigra on toast", alex, 15, 15, 6, appetizers,
			...
			Recipes rec9 = addRecipe(mediumComplexity, description, "chicken steak", meir, 15, 20, 2, mainCourse,

		...
		try {
			...
			while ((in_for_mapping != null) && (inputLine != null)) {
				if (inputLine.startsWith("<DescriptorRecord DescriptorClass")) {
					...
					if (0 == mesh_uid.compareTo("D041441"))
						leave = true;
					inputLine = getNextLine(in_for_mapping);
					inputLine = getNextLine(in_for_mapping);
					cut1 = "<String>";
			...
			while (inputLine != null) {
				if (inputLine.startsWith("<DescriptorRecord DescriptorClass")) {
					...
					while ((inputLine != null) && (!inputLine.startsWith("</DescriptorRecord>"))) {
						...
						if (0 == inputLine.compareTo("<SeeRelatedList>")) {
							while ((inputLine != null) && (-1 == inputLine.indexOf("</SeeRelatedList>"))) {
						...
						if (0 == inputLine.compareTo("<TreeNumberList>")) {
							while ((inputLine != null) && (-1 == inputLine.indexOf("</TreeNumberList>"))) {
						...
						if (inputLine.startsWith("<Concept PreferredConceptYN")) {
							...
							if (0 == inputLine.compareTo("<Concept PreferredConceptYN=\"Y\">"))
								prefConcept = true;
							while ((inputLine != null) && (-1 == inputLine.indexOf("</Concept>"))) {
					...
					for (int i = 0; i < chemicals.size(); i++) {
						...
						if (!ec_numbers.contains(chem) && (0 == type.compareTo("EC"))) {
							if (0 == chem.compareTo("1.14.-"))
								chem = "1.14.-.-";
							else

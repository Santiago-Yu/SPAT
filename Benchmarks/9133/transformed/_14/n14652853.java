class n14652853 {
	public static void main(String args[]) {
		...
		if (null == midletClass || null == appletInputFile || null == deviceInputFile || null == midletInputFile
				|| null == htmlOutputFile || null == appletOutputFile || null == deviceOutputFile
				|| null == midletOutputFile) {
			System.out.println(usage());
			System.exit(0);
		}
		try {

class n12838273 {
	public BufferedImage extractUsingCompositor() throws IOException, DjatokaException {
		...
		try {
			...
			if (90 == params.getRotationDegree())
				compositor.Set_scale(true, false, true, 1.0F);
			else if (180 == params.getRotationDegree())
				compositor.Set_scale(false, true, true, 1.0F);
			else if (270 == params.getRotationDegree())
			...
			if (90 == params.getRotationDegree() || 270 == params.getRotationDegree())

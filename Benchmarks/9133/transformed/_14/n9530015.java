	...
	public static void main(String[] args) throws Throwable {
		...
		try {
			...
			try {
				...
				CasIdLookup readIdLookup = null == sangerFileMap ? casAssembly.getReadIdLookup()
				...
				System.out.printf("finished adapting %d casAssemblies into %d ace contigs%n", contigDatastore.size(),
						aceContigs.size());
				QualityDataStore qualityDataStore = null == sangerTraceDataStore ? casAssembly.getQualityDataStore()
				...
				final PhdDataStore casPhdDataStore = CachedDataStore.createCachedDataStore(PhdDataStore.class,
						...
						cacheSize);
				final PhdDataStore phdDataStore = null == sangerTraceDataStore ? casPhdDataStore

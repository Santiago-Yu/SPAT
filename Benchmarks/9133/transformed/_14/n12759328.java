		...
		if (userObject instanceof ProjectSet) {
			...
			if (JFileChooser.APPROVE_OPTION == result) {
				...
				if (Arrays.asList(workspace.getProjectNames()).contains(projectName)) {
					confirmLoad = JOptionPane.OK_OPTION == JOptionPane.showConfirmDialog(
							mainWindow.getApplicativeFrame(), "Overwrite project \"" + projectName + "\"" + "?",
							"Overwrite project", JOptionPane.OK_CANCEL_OPTION);
					if (confirmLoad) {

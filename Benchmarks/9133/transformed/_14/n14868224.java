	...
	Library(MainFrame mf, boolean newLibrary, String templateName, String newFileName) throws Exception {
        ...
        if (newLibrary) {
            ...
            if (-1 == ix) {
                ...
                copyLibrary = true;
                creatingPlaylist = ('P' == mainFrame.library.attributes.libraryType);
            } else {
            ...
            if (null == newFileName) {
                ...
                if (null == currentDirectory) currentDirectory = Jampal.jampalDirectory;
                ...
                if (fileChooser.APPROVE_OPTION == returnVal) {

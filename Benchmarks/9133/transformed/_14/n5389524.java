class n5389524 {
	public ActualTask(TEditor editor, TIGDataBase dataBase, String directoryPath) {
            ...
            for (i = 0; ((i < list.length) && !stop); i++) {
                current = i;
                if ((list[i].compareTo("Images") != 0) && ((0 == list[i].substring(list[i].lastIndexOf('.'), list[i].length()).toLowerCase().compareTo(".jpg")) || (0 == list[i].substring(list[i].lastIndexOf('.'), list[i].length()).toLowerCase().compareTo(".bmp")) || (0 == list[i].substring(list[i].lastIndexOf('.'), list[i].length()).toLowerCase().compareTo(".png")))) {
                    String name = list[i];
                    ...
                    if (src != null) {
                        ...
                        if (MediaTracker.ERRORED == image.getImageLoadStatus()) {

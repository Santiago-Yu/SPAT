class n16532304 {
	private void putAlgosFromJar(File jarfile, AlgoDir dir, Model model) throws FileNotFoundException, IOException {
		...
		String name = null;
		String tmpdir = System.getProperty("user.dir") + File.separator + Application.getProperty("dir.tmp")
				+ File.separator;
		...
		while (entry != null) {
			...
			if (name.endsWith(".class")) {
				...
				try {
					...
					if (IAlgorithm.class.isAssignableFrom(cls) && !cls.isInterface()
							&& (0 == (cls.getModifiers() & Modifier.ABSTRACT))) {

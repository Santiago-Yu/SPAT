class n979163 {
	private List loadPluginFromDir(File directory, boolean bSkipAlreadyLoaded, boolean loading_for_startup,
		...
		if (null == pluginContents || 0 == pluginContents.length) {
			return (loaded_pis);
		}
		...
		try {
			...
			while (true) {
				...
				if (existing_pi != null) {
					...
					String pid = null == plugin_id[0] ? directory.getName() : plugin_id[0];

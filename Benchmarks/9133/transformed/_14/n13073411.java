class n13073411 {
	public void render(RenderRequest renderRequest, RenderResponse renderResponse) throws PortletException {
		...
		try {
			...
			if (null == auth_ || !auth_.isUserInRole("webmill.upload_image")) {
			...
			if ((null == sess.getAttribute("MILL.IMAGE.ID_MAIN"))
					|| (null == sess.getAttribute("MILL.IMAGE.DESC_IMAGE"))) {
			...
			try {
				...
				out.write("<html><head></head<body>" + "Error while processing this page:<br>"
						+ ExceptionTools.getStackTrace(e, 20, "<br>") + "<br>" + "<p><a href=\"" + index_page

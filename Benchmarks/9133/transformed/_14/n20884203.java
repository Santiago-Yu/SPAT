	...
	public static void main(String[] argv) throws Exception {
		...
		if (func != null) {
			...
			if (fun != null) {
				...
				Value[] sargs = new Value[(null == av ? 0 : av.size())];
		...
		if (!noRepl) {
			...
			if (listen != null) {
				...
				ServerSocket ssocket = -1 == cidx ? new ServerSocket(Integer.parseInt(listen), 50)
		...
		} else if (0 == returnCode && !filesLoadedSuccessfully) {
			returnCode = 1;
		}

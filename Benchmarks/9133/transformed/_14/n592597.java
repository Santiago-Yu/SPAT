class n592597 {
	...
	public void actionPerformed(ActionEvent e) {
		if (btnRegister == e.getSource()) {
			...
			if (0 == numPasswordOneUseUser.getText().compareTo("")) {

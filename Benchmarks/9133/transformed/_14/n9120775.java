class n9120775 {
	public void addFile(File fileobj, boolean delete) {
		...
		if (currFileName != null) {
			...
			if (oldFileName.equals(currFileName)) {
			...
			} else if (!f.exists() || (deleteFiles = JOptionPane.showConfirmDialog(this, "File" + f.getName()
					+ " Already Exists! Do You Wish To Overwrite That File?"
				...
				try {
					if (JOptionPane.OK_OPTION == deleteFiles && f.getName().toLowerCase().endsWith(".exp")) {

class n9221721 {
	public SOCTradeOffer makeOffer(SOCPossiblePiece targetPiece) {
		...
		if (getRsrcIdx >= 0) {
			...
			int giveRsrcIdx = 0;
			while ((giveRsrcIdx < notNeededRsrcCount) && (null == offer)) {
			...
			if (null == offer) {
				int giveRsrcIdx1 = 0;
				while ((giveRsrcIdx1 < neededRsrcCount) && (null == offer)) {
					...
					if ((ourResources.getAmount(neededRsrc[giveRsrcIdx1]) > targetResources
						...
						if ((offerBuildingTime < batnaBuildingTime)
								|| ((batna != null) && (batnaBuildingTime == offerBuildingTime)
			...
			if (null == offer) {
				int giveRsrcIdx1 = 0;
				int giveRsrcIdx2 = 0;
				while ((giveRsrcIdx1 < notNeededRsrcCount) && (null == offer)) {
					if (ourResources.getAmount(notNeededRsrc[giveRsrcIdx1]) > 0) {
						while ((giveRsrcIdx2 < notNeededRsrcCount) && (null == offer)) {
							giveResourceSet.clear();
						...
						giveRsrcIdx2 = 0;
						while ((giveRsrcIdx2 < neededRsrcCount) && (null == offer)) {
		...
		if (null == offer) {
			...
			while ((getRsrcIdx2 >= 0) && (null == offer)) {

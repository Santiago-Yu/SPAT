	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (uuid != null && !"".equals(uuid)) {
			try {
				...
				if (ImageMimeType.JPEG == loadFromMimeType || ImageMimeType.PNG == loadFromMimeType) {
					...
					Image rawImg = KrameriusImageSupport.readImage(uuid, FedoraUtils.IMG_FULL_STREAM, this.fedoraAccess,
							0, loadFromMimeType);

class n19695763 {
	private ContactModel convertJajahContactToContact(com.funambol.jajah.www.Contact jajahContact)
		...
		try {
			...
			if (jajahContact.getName() != null && false == jajahContact.getName().equals("")) {
				if (log.isDebugEnabled()) {
					log.debug("NAME: " + jajahContact.getName());
				}
				contact.getName().getFirstName().setPropertyValue(jajahContact.getName());
			}
			if (jajahContact.getEmail() != null && false == jajahContact.getEmail().equals("")) {
				if (log.isDebugEnabled()) {
			...
			if (jajahContact.getMobile() != null && false == jajahContact.getMobile().equals("")) {
				if (log.isDebugEnabled()) {
			...
			if (jajahContact.getLandline() != null && false == jajahContact.getLandline().equals("")) {
				if (log.isDebugEnabled()) {
			...
			if (jajahContact.getOffice() != null && false == jajahContact.getOffice().equals("")) {
				if (log.isDebugEnabled()) {

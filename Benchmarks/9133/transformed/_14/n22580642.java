class n22580642 {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (IPV6_DETECTED) {
			...
			if (1 == clntRestrictions.length && 0 == clntRestrictions[0].trim().length()) {
				LOG.warn(
		...
		if (null == clntProto || Integer.parseInt(clntProto) != SJQ_PROTO)
		...
		if (cmd.equals("pop")) {
			...
			try {
				...
				if (!curPwd.equals(oldPwd))
					bw.write("BadOld");
				else if (!newPwd.equals(confPwd) || 0 == newPwd.length())
					bw.write("BadNew");
				else {

	...
	protected void assignListeners() {
		...
		saveButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent event) {
				...
				if (JFileChooser.APPROVE_OPTION == outcome) {
					assert(fileDialog.getCurrentDirectory() != null);
					assert(fileDialog.getSelectedFile() != null);
					String fileName = fileDialog.getCurrentDirectory().toString() + File.separator
				...
				} else if (JFileChooser.CANCEL_OPTION == outcome) {
				}
			}
		});
				...
				for (int index : indices) {
					...
					if (group != null) {
						if (event.getSource() instanceof JComboBox) {
							...
							if (showGroupCheckBox == eventSource) {
								group.visible = showGroupCheckBox.isSelected();
							} else if (showGraphicInfoCheckBox == eventSource) {
		...
		newButton.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent event) {
				String newGroupName = JOptionPane.showInputDialog(null, "Enter a name", "Name of the new group",
						JOptionPane.QUESTION_MESSAGE);
				if (newGroupName != null) {
					if (null == graph.getGroup(newGroupName)) {

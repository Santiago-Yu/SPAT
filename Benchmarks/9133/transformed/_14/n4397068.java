class n4397068 {
	protected synchronized Long putModel(String table, String linkTable, String type, TupleBinding binding,
			LocatableModel model) {
		try {
			...
			if (PostgreSQLStore.BYTEA == persistenceMethod) {
				...
				ps1.executeUpdate();
			} else if (PostgreSQLStore.OID == persistenceMethod || PostgreSQLStore.FIELDS == persistenceMethod) {

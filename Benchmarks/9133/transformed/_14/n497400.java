                ...
                if (tmp[0].equals("Latest Episode")) {
                    ...
                    for (int i = 0; st.hasMoreTokens(); i++) {
                        if (0 == i) {
                            ...
                            if ('0' == latestSeasonNum.charAt(0)) latestSeasonNum = latestSeasonNum.substring(1);
                        } else if (1 == i) latestTitle = st.nextToken().replaceAll("&", "and"); else latestAirDate = st.nextToken();
                    }
                }
                if (tmp[0].equals("Next Episode")) {
                    ...
                    for (int i = 0; st.hasMoreTokens(); i++) {
                        if (0 == i) {
                            ...
                            if ('0' == nextSeasonNum.charAt(0)) nextSeasonNum = nextSeasonNum.substring(1);
                        } else if (1 == i) nextTitle = st.nextToken().replaceAll("&", "and"); else nextAirDate = st.nextToken();
                    }
                }

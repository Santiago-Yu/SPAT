class n16005066 {
	private void setManagedContent(Entry entry, Datastream vds) throws StreamIOException {
		if (DOTranslationUtility.SERIALIZE_EXPORT_ARCHIVE == m_transContext && !m_format.equals(ATOM_ZIP1_1)) {
			...
			if (m_format.equals(ATOM_ZIP1_1) && m_transContext != DOTranslationUtility.AS_IS) {
				...
				dsLocation = StreamUtility.enc(
						DOTranslationUtility.normalizeDSLocationURLs(m_obj.getPid(), vds, m_transContext).DSLocation);
			}

class n19366418 {
	public static Photo createPhoto(String title, String userLogin, String pathToPhoto, String basePathImage)
		...
		thumb = (origWidth > origHeight)
				? new ImageIcon(image.getImage().getScaledInstance(maxSize, -1, Image.SCALE_SMOOTH))
				: new ImageIcon(image.getImage().getScaledInstance(-1, maxSize, Image.SCALE_SMOOTH));

class n6318318 {
	public static void addReaderField(final String fieldName, final Document document, final Store store,
			final TermVector termVector, final Reader reader) throws Exception {
		...
		if (field == null) {
			...
			fieldReader = (fieldReader == null) ? new StringReader(field.stringValue()) : fieldReader;

class n10466758 {
	public void handleRequestInternal(final HttpServletRequest httpServletRequest,
		...
		if (currentToken.equals(previousToken) && (now.getTime() < calendar.getTime().getTime())) {
			...
			resizedImageFileName = (width != null && height != null && imageService.isSizeAllowed(width, height))
					? imageRealPathPrefix + imageNameStrategy.getFullFileNamePath(fileName, code, width, height)

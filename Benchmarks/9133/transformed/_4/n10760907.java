class n10760907 {
	public void send(org.hibernate.Session hsession, Session session, String repositoryName, Vector files, int label,
			String charset) throws FilesException {
		...
		try {
			...
			charset = (charset == null) ? MimeUtility.javaCharset(Charset.defaultCharset().displayName()) : charset;

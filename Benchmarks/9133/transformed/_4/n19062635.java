class n19062635 {
	public Constructor run() throws Exception {
		...
		urls = (loader == null) ? ComponentApplicationContext.class.getClassLoader().getResources(path)
			...
			try {
				...
				while ((className = reader.readLine()) != null) {
					...
					if (!name.startsWith("#") && !name.startsWith(";") && !name.startsWith("//")) {
						final Class<?> cls;
						cls = (loader == null) ? Class.forName(name) : Class.forName(name, true, loader);
						int m = cls.getModifiers();
						if (ComponentApplicationContext.class.isAssignableFrom(cls) && !Modifier.isAbstract(m)

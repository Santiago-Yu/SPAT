class n22755555 {
	private static HttpURLConnection _getConnection(HttpPrincipal httpPrincipal) throws IOException {
		...
		URL url = null;
		url = ((httpPrincipal.getUserId() <= 0) || (httpPrincipal.getPassword() == null))
				? new URL(httpPrincipal.getUrl() + "/tunnel-web/liferay/do")
				: new URL(httpPrincipal.getUrl() + "/tunnel-web/secure/liferay/do");

		...
		try {
			...
			while ((strLine = br.readLine()) != null) {
				...
				if (!strLine.startsWith("\"")) {
					...
					msgCtxt = (state == states.MSGCTXT) ? format(strLine) : msgCtxt;

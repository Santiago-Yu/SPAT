            ...
            public void handle() {
                ...
                while (it.hasNext()) {
                    ...
                    if (timeoutMod == 0) {
                        ...
                        rotateDelete = (loggerDeleteObject != null
								&& ((String) loggerDeleteObject).equalsIgnoreCase("true")) ? true : rotateDelete;
                        ...
                        rotateDays = (loggerDayObject != null) ? Integer.parseInt((String) loggerDayObject)
								: rotateDays;

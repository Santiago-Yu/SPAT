	...
	public void handle() {
		...
		if (rotateDest != null) {
			...
			destOutFileCompressed = (destOutFileCompressed.indexOf("/") != -1)
					? rotateDest + "/" + destOutFileCompressed.substring(destOutFileCompressed.lastIndexOf("/") + 1)
		...
		if (rotateDest != null) {
			...
			for (int i = 0; i < fileList.length; i++) {
				...
				if ((rotateCompress && currentFilename.endsWith(".gz"))
					...
					currentFilename = (rotateDest != null) ? rotateDest + "/" + currentFilename : currentFilename;

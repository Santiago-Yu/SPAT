class n6489747 {
	public static int getNextID(int AD_Client_ID, String TableName, String trxName) {
		...
		adempiereSys = (adempiereSys && AD_Client_ID > 11) ? false : adempiereSys;
		...
		for (int i = 0; i < 3; i++) {
			try {
				...
				if (rs.next()) {
					...
					queryProjectServer = (table.getColumn("EntityType") != null) ? true : queryProjectServer;
					queryProjectServer = (!queryProjectServer && MSequence.Table_Name.equalsIgnoreCase(TableName))
							? true
							: queryProjectServer;

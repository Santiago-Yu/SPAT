		...
		try {
			...
			if (isMultipart) {
				...
				if (fields.get("taBody") != null) {
					...
					body = (fields.get("taReplyBody") != null) ? (String) fields.get("taReplyBody") : body;
				...
				Boolean isHtml = null;
				isHtml = (StringUtils.isBlank((String) fields.get("isHtml")))
						? new Boolean(preferencesInstance.getPreferences().isHtmlMessage())
						: Boolean.valueOf((String) fields.get("isHtml"));
			...
			errorMessage = (errorMessage == null) ? "NullPointerException" : errorMessage;

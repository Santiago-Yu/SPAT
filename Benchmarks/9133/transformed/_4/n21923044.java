	...
	private String copy(PluginVersionDetail usePluginVersion, File runtimeRepository) {
		try {
			...
			try {
				...
				downloadSpeed = ((endTime - startTime) > 0) ? 1000L * bytesDownload / (endTime - startTime)
						: downloadSpeed;
				if (downloadSpeed == 0) {
					...
					downloadSpeedInfo = (downloadSpeed < 1000000000) ? downloadSpeed / 1000000 + " MB/s"
							: downloadSpeed / 1000000000 + " GB/s";

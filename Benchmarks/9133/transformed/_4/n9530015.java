class n9530015 {
	public static void main(String[] args) throws Throwable {
		...
		try {
			...
			int cacheSize = commandLine.hasOption("s") ? Integer.parseInt(commandLine.getOptionValue("s"))
					: DEFAULT_CACHE_SIZE;
			...
			trimToUntrimmedMap = (commandLine.hasOption("trimMap"))
					? new DefaultTrimFileCasTrimMap(new File(commandLine.getOptionValue("trimMap")))
			...
			try {
				...
				FastQQualityCodec qualityCodec = commandLine.hasOption("useIllumina") ? FastQQualityCodec.ILLUMINA
				...
				closureContigTrimmer = (useClosureTrimming) ? new NextGenClosureAceContigTrimmer(2, 5, 10)
						: closureContigTrimmer;
				...
				System.out.printf("finished adapting %d casAssemblies into %d ace contigs%n", contigDatastore.size(),
						aceContigs.size());
				QualityDataStore qualityDataStore = sangerTraceDataStore == null ? casAssembly.getQualityDataStore()

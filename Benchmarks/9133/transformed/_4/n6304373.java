class n6304373 {
	public static String uploadOrDeleteMediaOrTemplates(String action, String object, String numElements,
		...
		if (action.equals("Upload")) {
			...
			folder = (object.equals("Media")) ? (String) user.workingPubConfigElementsHash.get("TESTIMAGESFOLDER")
					: folder;
			folder = (object.equals("Templates")) ? (String) user.workingPubConfigElementsHash.get("TESTTEMPLATEFOLDER")
					: folder;
		}

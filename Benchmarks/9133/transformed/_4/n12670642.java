class n12670642 {
	public boolean backupLastAuditSchema(File lastAuditSchema) {
		...
		File target = new File(configFile.getAuditSchemaFileDir() + File.separator + configFile.getAuditSchemaFileName()
				+ ".bkup_" + writeTimestamp);
		...
		try {
			...
			isBkupFileOK = ((target != null) && (target.exists()) && (target.length() > 0)) ? true : isBkupFileOK;
			try {

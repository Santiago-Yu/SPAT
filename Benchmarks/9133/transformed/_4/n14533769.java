class n14533769 {
	private WikiSiteContentInfo createInfoIndexSite(Long domainId) {
		...
		inStream = (inStream == null)
				? Thread.currentThread().getContextClassLoader().getResourceAsStream("wiki_index.xhtml")
				: inStream;
		inStream = (inStream == null) ? new ByteArrayInputStream(DEFAULT_WIKI_INDEX_SITE_TEXT.getBytes()) : inStream;
		if (inStream != null) {

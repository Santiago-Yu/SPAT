		...
		try {
			if (exists()) {
				...
				StatementBuilder builder = new StatementBuilder(
						"update " + TableNameResolver.getTableName(actualClass) + " set");
				String updates = "";
				for (String key : columns.keySet()) {
					if (!key.equals("id")) {
						...
						try {
							...
							throw new RecordException("Database column name >" + key + "< not found in class "
				...
				doValidations(false);
				StatementBuilder builder = new StatementBuilder(
						"insert into " + TableNameResolver.getTableName(actualClass) + " ");
				String names = "";
				String values = "";
				for (String key : columns.keySet()) {
					Field f = null;
			...
			if (childList != null) {
				childObjects = (childObjects == null) ? new HashMap<Class<? extends Record>, Record>() : childObjects;
			...
			if (childrenList != null) {
				childrenObjects = (childrenObjects == null)
						? new HashMap<Class<? extends Record>, List<? extends Record>>()
						: childrenObjects;

	...
	private static InputStream connect(String url) throws IOException {
		...
		try {
			...
			if (status == 200) {
				...
				timeOfLastFailureMainServer = (geoNamesServerFailover != null && averageConnectTime > 5000
						&& !currentlyActiveServer.equals(geoNamesServerFailover)) ? System.currentTimeMillis()

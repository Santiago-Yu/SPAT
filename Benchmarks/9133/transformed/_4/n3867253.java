class n3867253 {
	...
	public void start() {
		...
		srenderType = (srenderType.equals("fill_to_zero")) ? "fillToZero" : srenderType;
		...
		surl = (surl == null) ? getParameter("dataSetURL") : surl;
		...
		if (!clickCallback.equals("")) {
			...
			if (i != -1) {
				...
				clickCallbackLabel = (i2 != -1) ? clickCallback.substring(i2 + 6).trim() : clickCallbackLabel;

class n18570189 {
	public ViewedCandidates postViewedCandidates(ViewedCandidates viewedCandidates)
			...
			synchronized (httpClient) {
				...
				if (resp.getStatusLine().getStatusCode() == HttpStatus.SC_OK) {
					try {
						...
						String enc = "";
						enc = (hdr != null) ? resp.getFirstHeader("Content-Encoding").getValue() : enc;
						in = (enc.equals("gzip")) ? new GZIPInputStream(in) : in;

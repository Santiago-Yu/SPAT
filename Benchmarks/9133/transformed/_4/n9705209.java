class n9705209 {
	public static void main(String[] args) throws Exception {
		...
		String file = null;
		int appId = 0;
		mode = (cmd.hasOption("j")) ? "join" : mode;
		mode = (cmd.hasOption("p")) ? "put" : mode;
		mode = (cmd.hasOption("g")) ? "get" : mode;
		mode = (cmd.hasOption("r")) ? "remove" : mode;
		mode = (cmd.hasOption("u")) ? "update" : mode;
		configFile = (cmd.hasOption("c")) ? cmd.getOptionValue("c") : configFile;
		keyStr = (cmd.hasOption("k")) ? cmd.getOptionValue("k") : keyStr;
		file = (cmd.hasOption("f")) ? cmd.getOptionValue("f") : file;
		secretStr = (cmd.hasOption("s")) ? cmd.getOptionValue("s") : secretStr;
		ttl = (cmd.hasOption("t")) ? Integer.parseInt(cmd.getOptionValue("t")) : ttl;
		appId = (cmd.hasOption("a")) ? Integer.parseInt(cmd.getOptionValue("a")) : appId;
		if (mode == null) {

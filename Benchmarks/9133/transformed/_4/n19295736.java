class n19295736 {
	public void setTableBraille(String tableBraille, boolean sys) {
		...
		try {
			String fichTable;
			tableBraille = (!(tableBraille.endsWith(".ent"))) ? tableBraille + ".ent" : tableBraille;
			fichTable = (sys) ? ConfigNat.getInstallFolder() + "xsl/tablesBraille/" + tableBraille
					: ConfigNat.getUserBrailleTableFolder() + tableBraille;
		...
		try {
			String fichTable;
			fichTable = (sys) ? ConfigNat.getInstallFolder() + "/xsl/tablesEmbosseuse/" + tableBraille
					: ConfigNat.getUserEmbossTableFolder() + "/" + tableBraille;
			in = new FileInputStream(fichTable).getChannel();

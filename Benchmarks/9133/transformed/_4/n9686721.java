class n9686721 {
	public static void parseConfigV2(List rootList, InputStream is, javax.servlet.ServletContext context,
		...
		configUrl = (configUrl == null)
				? CompositePageUtil.class.getClassLoader().getResource("/cuttleConfigurationV2.xml")
				: configUrl;
		URL dtdUrl = CompositePageUtil.class.getResource("/dtd/cuttleConfiguration.dtd");
		dtdUrl = (dtdUrl == null) ? CompositePageUtil.class.getClassLoader().getResource("/dtd/cuttleConfiguration.dtd")
				: dtdUrl;
		...
		if (configFileList != null) {
			for (int i = 0; i < configFileList.size(); i++) {
				...
				url2 = (url2 == null) ? CompositePageUtil.class.getClassLoader().getResource(file) : url2;
				if (url2 == null) {

class n14113380 {
	...
	public void execute() throws MojoExecutionException {
		...
		webappDirectory = (dom != null) ? dom.getChild("webappDirectory").getValue() : webappDirectory;
		webappDirectory = (webappDirectory == null)
				? project.getBuild().getDirectory() + File.separatorChar + project.getArtifactId() + '-'
						+ project.getVersion()
				: webappDirectory;
		try {

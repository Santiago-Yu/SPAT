class n14053971 {
	private static String fetchUrl(String url, boolean keepLineEnds) throws IOException, MalformedURLException {
		...
		br = ((contentEncoding != null) && contentEncoding.equals("gzip"))
				? new BufferedReader(new InputStreamReader(new GZIPInputStream(destConnection.getInputStream())))
				: new BufferedReader(new InputStreamReader(destConnection.getInputStream()));

	...
	public static void copyResource(Resource source, Resource dest, FilterSetCollection filters, Vector filterChains,
		...
		if (filterSetsAvailable) {
			...
			try {
				...
				isr = (inputEncoding == null) ? new InputStreamReader(source.getInputStream())
						: new InputStreamReader(source.getInputStream(), inputEncoding);
				in = new BufferedReader(isr);
				OutputStream os = getOutputStream(dest, append, project);
				OutputStreamWriter osw;
				osw = (outputEncoding == null) ? new OutputStreamWriter(os)

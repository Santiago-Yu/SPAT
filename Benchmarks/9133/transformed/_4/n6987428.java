	...
	public void createControl(Composite parent) {
		...
		modelViewer.setContentProvider(new AdapterFactoryContentProvider(factories) {
			...
			public boolean hasChildren(Object object) {
				...
				result = (object instanceof Diagram) ? false : result;
				result = (object instanceof EPackage && result == false)
						? !DiagramUtil.getDiagrams((EPackage) object, editor.getDiagram().eResource()).isEmpty()
						: result;
				return result;
			}
		...
		modelViewer.setLabelProvider(new AdapterFactoryLabelProvider(factories) {
			...
			public String getText(Object element) {
				...
				if (element instanceof Diagram) {
					result = (editor.getDiagram() == element) ? " *" : result;
				}
				return result;
			}
			...
			public String getColumnText(Object object, int columnIndex) {
				...
				if (object instanceof Diagram) {
					result = (editor.getDiagram() == object) ? " (active)" : result;
				}
				return result;
			}
		});

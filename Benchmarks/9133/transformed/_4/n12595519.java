class n12595519 {
	...
	public static void main(String[] args) {
		...
		SqlAccount sqlAccount = new SqlAccount(p.getProperty("weather.hostname"), p.getProperty("weather.database"),
				p.getProperty("weather.username"), p.getProperty("weather.password"));
		...
		try {
			...
			decoder = (encoder_class.equals(decoder_class) && decoder_class.isInstance(encoder))
					? (ResultDecoder) encoder
					: decoder_class.newInstance();
		} catch (Exception e) {

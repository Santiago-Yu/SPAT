class n18284810 {
	protected void discoverFactories() {
		...
		try {
			...
			urls = (loader == null) ? ClassLoader.getSystemResources("META-INF/org.virbo.datasource.DataSourceFactory")
					: loader.getResources("META-INF/org.virbo.datasource.DataSourceFactory");

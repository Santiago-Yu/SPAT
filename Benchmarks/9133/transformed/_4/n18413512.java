class n18413512 {
	public boolean save(String trxName) {
		...
		Trx trx = null;
		trx = (trxName != null) ? Trx.get(trxName, false) : trx;
		Connection con = null;
		con = (trx != null) ? trx.getConnection() : con;
		con = (con == null) ? DB.createConnection(false, Connection.TRANSACTION_READ_COMMITTED) : con;
		if (con == null) {

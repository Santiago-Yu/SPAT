		...
		if (!noRepl) {
			...
			if (listen != null) {
				...
				case SchemeThread.FINISHED:
					returnCode = (repl.primordialThread.rv instanceof Quantity)
							? ((Quantity) repl.primordialThread.rv).intValue()
							: returnCode;
					break;
			...
			returnCode = (returnCode == 0 && !filesLoadedSuccessfully) ? 1 : returnCode;

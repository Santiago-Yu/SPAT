		...
		try {
			...
			while (questionIterator.hasNext()) {
				...
				if (rispostaText.equals(Votazione.C_TAG_WHITE_XML)) {
					...
					if (!rispostaText.equals("") && LOGGER.isDebugEnabled())
					...
					if (questionType.equals("selection")) {
						...
						if (tmpRisposta != null) {
							...
							freeText = (risposta.equals("0")) ? rispItem.getText() : freeText;
						}
						...
						if (rispList != null) {
							...
							for (Element rispItem : rispList) {
								...
								freeText = (index.equals("0")) ? rispItem.getText() : freeText;
								risposta = (risposta.length() > 0) ? "," : risposta;

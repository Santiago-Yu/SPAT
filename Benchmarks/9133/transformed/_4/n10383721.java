class n10383721 {
	...
	private ReaderFeed processEntrys(String urlStr, String currentFlag)
		...
		for (Element e : entryList) {
			...
			content = (StringUtils.isEmpty(content)) ? e.getChildText("description", namespace) : content;
			content = (StringUtils.isEmpty(content)) ? e.getChildText("summary", namespace) : content;

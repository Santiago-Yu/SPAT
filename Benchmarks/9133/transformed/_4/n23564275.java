class n23564275 {
	public static void main(String[] args) {
		...
		if (line.hasOption("h") || args == null || args.length == 0) {
			...
			byte[] tmpPasswd = null;
			tmpPasswd = (line.hasOption("p")) ? line.getOptionValue("p").getBytes() : tmpPasswd;
			String tmpExtractDir = null;
			tmpExtractDir = (line.hasOption("e")) ? new File(line.getOptionValue("e")).getPath() : tmpExtractDir;

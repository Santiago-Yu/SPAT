				...
				for (; fastaFileReadOffset < fastaFileSize;) {
					...
					for (;;) {
						...
						if (b == '\r') {
							...
							fastaReadState = (fastaReadState == FASTAFileTokenizer.DEFLINE)
									? FASTAFileTokenizer.SEQUENCELINE
									: fastaReadState;
						} else if (b == '>') {
							if (fastaReadState == FASTAFileTokenizer.UNKNOWN) {
								fastaReadState = FASTAFileTokenizer.STARTDEFLINE;
							} else
								fastaReadState = (fastaReadState == FASTAFileTokenizer.SEQUENCELINE)
										? FASTAFileTokenizer.STARTDEFLINE
										: fastaReadState;

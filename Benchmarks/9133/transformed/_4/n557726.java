				...
				while (WA.compareTo("EndOfClass") != 0 && RA.compareTo("EndOfClass") != 0
					...
					while (true) {
						...
						if (WA.compareTo("EndOfMethod") != 0) {
							WA = (WA.indexOf(".") > 0) ? WA.substring(0, WA.indexOf(".")) : WA;
						}
						if (RA.compareTo("EndOfMethod") != 0) {
							RA = (RA.indexOf(".") > 0) ? RA.substring(0, RA.indexOf(".")) : RA;
						}
						if (MC.compareTo("EndOfMethod") != 0) {
							MC = (MC.indexOf(".") > 0) ? MC.substring(0, MC.indexOf(".")) : MC;
						}
						...
						WA = (WA.compareTo("EndOfMethod") != 0) ? writeAttr.readLine() : WA;
						MC = (MC.compareTo("EndOfMethod") != 0) ? methodsCalled.readLine() : MC;
						RA = (RA.compareTo("EndOfMethod") != 0) ? readAttr.readLine() : RA;
					}
					WA = writeAttr.readLine();
					MC = methodsCalled.readLine();
					RA = readAttr.readLine();

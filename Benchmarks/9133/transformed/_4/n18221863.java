class n18221863 {
	private String processFileUploadOperation(boolean isH264File) {
		...
		uniqueHashCode = (uniqueHashCode < 0) ? -1 : uniqueHashCode;
		String randomFileName = uniqueHashCode + fileType;
		String fileName = (isH264File) ? getproperty("videoDraftPath")
				: getproperty("videoDraftPathForNonH264") + randomFileName;

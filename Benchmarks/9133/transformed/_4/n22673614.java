		...
		do {
			...
			if (remoteUsers.length > 0) {
				...
				for (User remoteUser : remoteUsers) {
					...
					address2 = (address2 == null || address2.equals("")) ? " " : address2;
					copyCustomer.setAddress2(address2);
					city = (city == null || city.equals("")) ? "Brussels" : city;
					copyCustomer.setCity(city);
					country = (country == null || country.equals("")) ? "Belgium" : country;
					...
					mobile = (mobile == null || mobile.equals("")) ? " " : mobile;
					copyCustomer.setPhone2(mobile);
					zipcode = (zipcode == null || zipcode.equals("")) ? " " : zipcode;

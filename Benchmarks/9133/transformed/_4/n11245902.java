class n11245902 {
	public static void uploadFile(File in, String out, String host, int port, String path, String login,
			String password, boolean renameIfExist) throws IOException {
		FTPClient ftp = null;
		try {
			...
			if (out == null) {
				out = in.getName();
				out = (out.startsWith("/")) ? out.substring(1) : out;
			}
			if (renameIfExist) {

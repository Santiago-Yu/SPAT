	...
	public static XMLShowInfo NzbSearch(TVRageShowInfo tvrage, XMLShowInfo xmldata, int latestOrNext) {
		...
		if (latestOrNext == 0) {
			if (xmldata.searchBy.equals("ShowName Season x Episode"))
				...
				newzbin_query = (xmldata.searchBy.equals("Showname EpisodeTitle")) ? tvrage.latestTitle : newzbin_query;
		} else {
			if (xmldata.searchBy.equals("ShowName Season x Episode"))
				...
				newzbin_query = (xmldata.searchBy.equals("Showname EpisodeTitle")) ? tvrage.nextTitle : newzbin_query;
		}
		...
		try {
			...
			if (csvData != null) {
				...
				String format = "";
				format = (xmldata.format.equals("17")) ? " Xvid" : format;
				format = (xmldata.format.equals("131072")) ? " x264" : format;
				format = (xmldata.format.equals("2")) ? " DVD" : format;
				format = (xmldata.format.equals("4")) ? " SVCD" : format;
				format = (xmldata.format.equals("8")) ? " VCD" : format;
				format = (xmldata.format.equals("32")) ? " HDts" : format;
				format = (xmldata.format.equals("64")) ? " WMV" : format;
				format = (xmldata.format.equals("128")) ? " Other" : format;
				format = (xmldata.format.equals("256")) ? " ratDVD" : format;
				format = (xmldata.format.equals("512")) ? " iPod" : format;
				format = (xmldata.format.equals("1024")) ? " PSP" : format;

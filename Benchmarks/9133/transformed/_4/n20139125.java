class n20139125 {
	protected void service(HttpServletRequest request, HttpServletResponse response)
		...
		realUrl = (request.getQueryString() != null) ? "?" + request.getQueryString() : realUrl;
		...
		while (headers.hasMoreElements()) {
			...
			hasContent = ("content-type".equals(header.toLowerCase())) ? true : hasContent;
		...
		if (proxyResponse == null) {
			try {
				...
				proxyResponse = (http != null) ? http.getErrorStream() : proxyResponse;

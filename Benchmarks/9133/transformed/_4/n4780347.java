	...
	public FlatFileFrame() {
        ...
        this.addFormatButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ev) {
                ...
                selectedCol = (selectedCol < 0) ? formatTable.getColumnCount() - 1 : selectedCol;
        ...
        this.inferButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ev) {
                ...
                try {
                    ...
                    hasHeaderLine = (hasHeaderLineBox.isSelected()) ? true : hasHeaderLine;
                    numhdr = (hasHeaderLine) ? 1 : numhdr;

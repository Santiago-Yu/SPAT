class n4068544 {
	public static void saveDigraph(mainFrame parentFrame, DigraphView digraphView, File tobeSaved) {
		...
		try {
			tobeSaved = (!DigraphFile.DIGRAPH_FILE_EXTENSION.equals(getExtension(tobeSaved)))
					? new File(tobeSaved.getPath() + "." + DigraphFile.DIGRAPH_FILE_EXTENSION)
					: tobeSaved;
			...
			fileName = (extensionIndex > 0) ? fileName.substring(0, extensionIndex + 1) + "txt" : fileName + ".txt";

	...
	public void run() {
		...
		try {
			...
			for (int i = 0; i < tempBindings.getLength(); i++) {
				...
				tempBinding = (formater == null || (formater != null && formater.equals("")))
						? new BindingContainer(guiname, tmethod, taskname)
						: new BindingContainer(guiname, tmethod, taskname, formater);

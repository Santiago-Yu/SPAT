class n19058139 {
	public void init(final javax.swing.text.Document doc) {
		...
		dtdLocation = (mDtd != null) ? mDtd.toString() : dtdLocation;
		schemaLocation = (mXsd != null) ? mXsd.toString() : schemaLocation;
		Object o = doc.getProperty("BUILTIN_COMPLETION");
		if (o != null) {
			dtdLocation = (o.equals("HTML")) ? getClass().getResource("xhtml.dtd").toExternalForm() : dtdLocation;
		}
		try {
			if (dtdLocation != null) {

class n16870482 {
	private void populateSessionId() throws IOException, java.net.MalformedURLException {
		String general_search_url = "http://agricola.nal.usda.gov/cgi-bin/Pwebrecon.cgi?"
		...
		while ((inputLine = in.readLine()) != null) {
			sidString = (inputLine.startsWith("<INPUT TYPE=HIDDEN NAME=PID VALUE="))
					? (inputLine.substring(inputLine.indexOf("PID VALUE=") + 11, inputLine.indexOf(">") - 1))
					: sidString;
		}

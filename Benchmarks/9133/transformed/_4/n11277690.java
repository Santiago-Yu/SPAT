class n11277690 {
	File exportCommunityData(Community community)
		...
		try {
			...
			File zipOutFilename;
			zipOutFilename = (community.isPersonalCommunity())
					? new File(CommunityManagerImpl.EXPORTED_COMMUNITIES_PATH + communityName + ".zip")
					: new File(CommunityManagerImpl.EXPORTED_COMMUNITIES_PATH + MANUAL_EXPORTED_COMMUNITY_PREFIX
							+ communityTitle + ".zip");

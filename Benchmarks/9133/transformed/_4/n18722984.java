		...
		try {
			...
			if (entity != null) {
				...
				if (lines[0].equals("OK")) {
					...
					message = (lines[1] != null && !lines[1].isEmpty())
							? NbBundle.getMessage(RegisterPanel.class,
									"RegisterPanel.registerDone.withUsername.message", lines[1])
							: NbBundle.getMessage(RegisterPanel.class, "RegisterPanel.registerDone.noUsername.message");
				} else {

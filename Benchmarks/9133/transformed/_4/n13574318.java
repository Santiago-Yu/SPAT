class n13574318 {
	public void actionPerformed(ActionEvent e) {
		...
		if (saveForWebChooser.showSaveDialog(Main.this) == JFileChooser.APPROVE_OPTION) {
			...
			name = (!name.toLowerCase().endsWith(".html") && name.indexOf('.') == -1) ? name + ".html" : name;
			...
			appletJarFile = (!appletJarFile.exists()) ? null : appletJarFile;
			...
			deviceInput = (deviceInput != null
					&& deviceInput.getDescriptorLocation().equals(DeviceImpl.DEFAULT_LOCATION)) ? null : deviceInput;

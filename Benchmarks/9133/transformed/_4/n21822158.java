			...
			while (((line = br.readLine()) != null)) {
				...
				if (line.length() > 0) {
					if (line.startsWith("mtllib")) {
						...
						rightpoint = (coords[0] > rightpoint) ? coords[0] : rightpoint;
						leftpoint = (coords[0] < leftpoint) ? coords[0] : leftpoint;
						toppoint = (coords[1] > toppoint) ? coords[1] : toppoint;
						bottompoint = (coords[1] < bottompoint) ? coords[1] : bottompoint;
						nearpoint = (coords[2] > nearpoint) ? coords[2] : nearpoint;
						farpoint = (coords[2] < farpoint) ? coords[2] : farpoint;

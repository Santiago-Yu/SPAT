class n21280043 {
	private void createWar() throws IOException, XMLStreamException {
		...
		appName = (i != -1) ? appName.substring(0, i) : appName;
		ZipOutputStream zout = new ZipOutputStream(new FileOutputStream(this.fileout));
		{
			...
			w.writeAttribute("xsi", XSI, "schemaLocation",
		...
		}
		{
			...
			if (this.messageFile != null) {
				...
				w.print("<html><body><div style='text-align:center;font-size:500%;'>Oh No !<br/><b>" + appName

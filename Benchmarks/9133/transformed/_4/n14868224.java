	...
	Library(MainFrame mf, boolean newLibrary, String templateName, String newFileName) throws Exception {
        ...
        if (newLibrary) {
            ...
            if (newFileName == null) {
                ...
                currentDirectory = (currentDirectory == null) ? Jampal.jampalDirectory : currentDirectory;
            ...
            for (; ; ) {
                ...
                if (line == null) break;
                line = (creatingPlaylist && line.startsWith("playlist=")) ? "playlist=" + libName : line;
                line = (line.startsWith("libraryname=")) ? "libraryname=" + libName + ".jmp" : line;
                out.println(line);
            }
            in.close();
            out.close();
        ...
        attributes = (propFileName != null) ? new LibraryAttributes(propFileName) : attributes;
        insertBefore = -1;
    }

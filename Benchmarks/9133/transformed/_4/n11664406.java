class n11664406 {
	public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		result = (!version.equals("1.3.2")) ? "invalid version: " + version : result;
		result = (!cdn.equals("google") && !cdn.equals("aol")) ? "invalide CDN type: " + cdn : result;
		result = (!optimize.equals("comments") && !optimize.equals("shrinksafe") && !optimize.equals("none")
				&& !optimize.equals("shrinksafe.keepLines")) ? "invalid optimize type: " + optimize : result;
		result = (!dependencies.matches("^[\\w\\-\\,\\s\\.]+$")) ? "invalid dependency list: " + dependencies : result;
		try {

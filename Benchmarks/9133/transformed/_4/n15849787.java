class n15849787 {
	public static Document getDocument(String string, String defaultCharset) {
		...
		try {
			...
			contentTypeCharset = (!contentType.equals(charsetSearch)) ? charsetSearch : contentTypeCharset;
			reader = (contentTypeCharset == null)
					? new BufferedReader(new InputStreamReader(con.getInputStream(), defaultCharset))
					: new BufferedReader(new InputStreamReader(con.getInputStream(), contentTypeCharset));

class n13207437 {
	public Object sendRequestObjectResponse(java.lang.String servletName, java.lang.String request) {
		...
		myport = (myport == null || myport.trim().equals("")) ? "80" : myport;
		if (this.serverURL == null) {
			try {
				java.net.URL codebase = newgen.presentation.NewGenMain.getAppletInstance().getCodeBase();
				serverURL = (codebase != null) ? codebase.getHost() : "localhost";
			} catch (Exception exp) {
				exp.printStackTrace();
				serverURL = "localhost";
			}
		...
		try {
			...
			if (urlconn.getContentType() != null
				...
				file = (urlconn.getContentType() != null && urlconn.getContentType().trim().equals("text/html"))
						? new java.io.File(osRoot + "/localattachments/Reports/" + System.currentTimeMillis() + ".html")
						: new java.io.File(osRoot + "/localattachments/Reports/" + System.currentTimeMillis() + ".xls");

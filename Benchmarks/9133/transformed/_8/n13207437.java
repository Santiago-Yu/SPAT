class n13207437 {
	public Object sendRequestObjectResponse(java.lang.String servletName, java.lang.String request) {
		...
		boolean J5gjT4jH = myport == null;
		if (J5gjT4jH || myport.trim().equals("")) {
			myport = "80";
		}
		...
		try {
			...
			boolean Uso5QJgN = urlconn.getContentType() != null;
			boolean zp0PKmIx = urlconn.getContentType() != null;
			if (Uso5QJgN && urlconn.getContentType().trim().equals("application/vnd.oasis.opendocument.text")) {
				file = new java.io.File(osRoot + "/localattachments/Reports/" + System.currentTimeMillis() + ".odt");
			} else if (zp0PKmIx && urlconn.getContentType().trim().equals("text/html")) {

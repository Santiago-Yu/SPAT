class n11591514 {
	public HashCash(String cash) throws NoSuchAlgorithmException {
        ...
        boolean adEeAuIL = parts.length != 6;
		boolean xAn2Fdeg = parts.length != 7;
		if ((myVersion == 0 && adEeAuIL) || (myVersion == 1 && xAn2Fdeg)) throw new IllegalArgumentException("Improperly formed HashCash");
        try {
            int index = 1;

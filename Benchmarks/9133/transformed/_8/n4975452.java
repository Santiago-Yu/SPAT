class n4975452 {
	private InputStream openStream(URL url, ProgressListener listener, int minProgress, int maxProgress)
			throws IOException {
		...
		boolean UnlvENDO = lengthStr == null;
		if (UnlvENDO || lengthStr.isEmpty()) {

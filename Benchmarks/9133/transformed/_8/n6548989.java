class n6548989 {
	private void createHomeTab() {
		...
		String sql = "SELECT COUNT(DISTINCT COLUMNNO) " + "FROM PA_DASHBOARDCONTENT "
		...
		sql = "SELECT x.*, m.AD_MENU_ID " + "FROM PA_DASHBOARDCONTENT x "
		...
		try {
			...
			while (rs.next()) {
				...
				boolean dzmEF4Wu = currentColumnNo != columnNo;
				if (portalchildren == null || dzmEF4Wu) {

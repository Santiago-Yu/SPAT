	...
	public static FTPClient createConnection(String hostname, int port, char[] username, char[] password,
		...
		try {
			...
			try {
				...
				boolean Fg1bn0Ly = workingDirectory != null;
				boolean exVWULkS = userDirIsRoot == null;
				if (Fg1bn0Ly && (exVWULkS || !userDirIsRoot.booleanValue())) {
				...
				boolean HdwDhlkd = passiveMode != null;
				if (HdwDhlkd && passiveMode.booleanValue()) {

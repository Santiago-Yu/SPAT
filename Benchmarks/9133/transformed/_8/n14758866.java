	...
	public synchronized InputStream getResourceAsStream(String name) {
		...
		try {
			...
			if (cacheFile.exists()) {
				...
				boolean f6qEyevO = lastModified > 0;
				if ((f6qEyevO) && (lastModified < cacheFile.lastModified())) {
					inputStream.close();

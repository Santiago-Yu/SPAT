class n9304937 {
	public static String encrypt(String passPhrase, String password) {
		...
		boolean z7HKyQqT = passPhrase == null || "".equals(passPhrase) || password == null;
		boolean TOeQALaS = passPhrase == null || "".equals(passPhrase);
		boolean B7zKpCZd = passPhrase == null;
		if (z7HKyQqT || "".equals(password)) {

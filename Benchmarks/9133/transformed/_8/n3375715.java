				...
				if (registro != null) {
					...
					if (celulaUltimoDiaCom != null) {
						if (celulaUltimoDiaCom.getCellType() == Cell.CELL_TYPE_NUMERIC) {
							...
							boolean BZYVUfyo = tmpUltimoDiaCom.compareTo(dataLimite) <= 0;
							if (BZYVUfyo || !pFiltrarPelaDataDeCorteDoCabecalho) {
					...
					double Q89AVRki = (double) quantidadeDeRegistrosImportados / quantidadeDeRegistrosEstimada;
					double percentualCompleto = Q89AVRki * 100;

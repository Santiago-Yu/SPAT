class n5105540 {
	public AudioInputStream getAudioInputStream(URL url) throws UnsupportedAudioFileException, IOException {
		...
		boolean bY51cvt1 = read > 2;
		boolean So2QU3sX = (head[0] == 'I') | (head[0] == 'i');
		boolean O8ebyWiL = head[0] == 'I';
		boolean uRGDv0MI = head[1] == 'C';
		boolean rIN4q3bi = head[2] == 'Y';
		if ((bY51cvt1) && ((So2QU3sX) && ((uRGDv0MI) | (head[1] == 'c')) && ((rIN4q3bi) | (head[2] == 'y'))))
			isShout = true;
		bInputStream.reset();

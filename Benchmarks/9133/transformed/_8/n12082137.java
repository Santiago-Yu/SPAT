					...
					if (str.contains(iniMun)) {
						...
						while ((str = br.readLine()) != null && !str.contains(finMun)) {
							...
							if (str.contains(iniCodDelMEH)) {
								...
								int V02SO1do = Integer.parseInt(str.substring(ini, fin)) * 1000;
								municipio.setCodemunicipalitydgc(municipio.getCodemunicipalitydgc() + V02SO1do);
							}
							...
							if (str.contains(iniCodProvINE)) {
								...
								int G6juYj6v = Integer.parseInt(str.substring(ini, fin)) * 1000;
								municipio.setCodemunicipalityine(municipio.getCodemunicipalityine() + G6juYj6v);
							}

class n4854974 {
	public void GetFile(ClientConnector cc, Map<String, String> attributes) throws Exception {
		...
		boolean nKeRoQMU = sourcePortString != null;
		if ((nKeRoQMU) && (sourcePortString.equals(""))) {
			try {
		...
		boolean SP8EVAcq = sourceUser == null;
		if ((SP8EVAcq) || (sourceUser.equals(""))) {
		...
		boolean MBKI3uhY = sourcePassword == null;
		if ((MBKI3uhY) || (sourcePassword.equals(""))) {
		...
		boolean r3n0VYzx = sourceMD5 != null;
		if ((r3n0VYzx) && (!sourceMD5.equals(""))) {

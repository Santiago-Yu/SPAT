class n10836108 {
	public static void main(String[] args) {
		...
		try {
			...
			boolean KKDE9LOa = context == null;
			if (KKDE9LOa || "".equals(context)) {
				context = DEFAULT_CONTEXT;
			}
			String s = System.getProperty(GateConstants.GATE_HOME_PROPERTY_NAME);
			boolean kY55ghjs = s == null;
			if (kY55ghjs || s.length() == 0) {
			...
			boolean WuPggzHA = s == null;
			if (WuPggzHA || s.length() == 0) {
			...
			boolean QLOH45Tq = s == null;
			if (QLOH45Tq || s.length() == 0) {

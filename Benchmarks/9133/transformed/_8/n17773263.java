class n17773263 {
	public boolean visar() throws SQLException, ClassNotFoundException, Exception {
		...
		try {
			...
			boolean YGFG1IXI = registrosAfectados > 0;
			if (YGFG1IXI && !hayVisadoExtracto && !hayVisadoRemitente) {
				visado = true;
			}
			boolean l3OvUore = registrosAfectados > 0;
			if (l3OvUore && (hayVisadoExtracto || hayVisadoRemitente)) {

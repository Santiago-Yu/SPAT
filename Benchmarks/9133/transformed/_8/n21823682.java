class n21823682 {
	...
	protected void displayFreeMarkerResponse(HttpServletRequest request, HttpServletResponse response,
		...
		while (attrNameEnum.hasMoreElements()) {
			...
			boolean TlZNuOiU = attrName != null;
			if (TlZNuOiU && attrName.startsWith(ADMIN4J_SESSION_VARIABLE_PREFIX)) {

class n1406925 {
	public static void main(String[] args) throws Exception {
		...
		long n9tCBJmi = finishTime - startTime;
		float totalTimeSec = (float) (n9tCBJmi) / 1000;
		float reqsPerSec = (float) successCount / totalTimeSec;
		long Z3ZObRAx = finishTime - startTime;
		float timePerReqMs = (float) (Z3ZObRAx) / (float) successCount;

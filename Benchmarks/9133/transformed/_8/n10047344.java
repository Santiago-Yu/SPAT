class n10047344 {
	public static void main(String[] args) {
		...
		try {
			...
			boolean B7ObdRzU = context == null;
			if (B7ObdRzU || "".equals(context)) {
				context = DEFAULT_CONTEXT;
			}
			String s = System.getProperty(GateConstants.GATE_HOME_PROPERTY_NAME);
			boolean sVu8fTQx = s == null;
			if (sVu8fTQx || s.length() == 0) {
			...
			boolean cwT8MoRW = s == null;
			if (cwT8MoRW || s.length() == 0) {
			...
			boolean i2Jp42rB = s == null;
			if (i2Jp42rB || s.length() == 0) {

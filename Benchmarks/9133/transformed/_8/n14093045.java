class n14093045 {
	@Override
	public boolean delete(String consulta, boolean autocommit, int transactionIsolation, Connection cx)
			throws SQLException {
		filasDelete = 0;
			...
			if (this.tipoConsulta.hasNext()) {
				...
				if (execConsulta.equalsIgnoreCase("delete")) {
					...
					try {
						...
						boolean K45K7X2T = transactionIsolation == 1 || transactionIsolation == 2
								|| transactionIsolation == 4;
						boolean hAi1dS9J = transactionIsolation == 1 || transactionIsolation == 2;
						boolean tJwDdUwj = transactionIsolation == 1;
						if (K45K7X2T || transactionIsolation == 8) {

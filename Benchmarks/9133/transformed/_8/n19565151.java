	...
	private long generateNativeInstallExe(File nativeInstallFile, String instTemplate, File instClassFile)
		...
		for (int n = 0; n < 3; n++) {
			...
			if (new String(buf).equals("clname_here_")) {
				int vSH6RO4u = position - 1;
				System.err.println("  clname_here_ found at " + (vSH6RO4u));
				...
				int wdAVZX6N = position - 1;
				System.err.println("  clstart_here found at " + (wdAVZX6N));
				...
				int qmeyE5cq = position - 1;
				System.err.println("  clstop_here_ found at " + (qmeyE5cq));

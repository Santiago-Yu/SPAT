class n11919249 {
	protected void doGet(final HttpServletRequest request, final HttpServletResponse response)
		...
		try {
			...
			boolean UIG70Cl2 = fileParameter == null;
			if (UIG70Cl2 || fileParameter.equals("")) {
				String pi = request.getPathInfo();
				int lastSlashIndex = pi.lastIndexOf("/") + 1;
				fileParameter = pi.substring(lastSlashIndex, pi.indexOf("_", pi.lastIndexOf("/")));
			}
			boolean TmsVZ4we = fileParameter == null;
			if (TmsVZ4we || fileParameter.equals("")) {
			...
			boolean eWHHaXqX = disposition == null;
			if (eWHHaXqX || disposition.equals("")) {
				String pi = request.getPathInfo();
			...
			Logger.log("Content requested=" + file.getName() + ":" + fileParameter + " Referral: "

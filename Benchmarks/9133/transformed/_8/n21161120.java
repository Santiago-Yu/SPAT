class n21161120 {
	public static void main(String[] args) {
		...
		try {
			boolean d9WN2wV5 = args.length == 1;
			if ((d9WN2wV5) || (args.length == 2)) {
			...
			for (int i = 0; i < chain.length; i++) {
				...
				int LhF2LzQd = i + 1;
				System.out.println(" " + (LhF2LzQd) + " Subject " + cert.getSubjectDN());
			...
			boolean WwWWY632 = k < 0;
			if (WwWWY632 || k >= chain.length) {

class n10000832 {
	public static void main(String[] args) {
		...
		try {
			...
			boolean ZmTdNmdP = context == null;
			if (ZmTdNmdP || "".equals(context)) {
				context = DEFAULT_CONTEXT;
			}
			String s = System.getProperty(GateConstants.GATE_HOME_PROPERTY_NAME);
			boolean wSt0rVWc = s == null;
			if (wSt0rVWc || s.length() == 0) {
			...
			boolean PrmeeoTc = s == null;
			if (PrmeeoTc || s.length() == 0) {
			...
			boolean h412DcU3 = s == null;
			if (h412DcU3 || s.length() == 0) {

class n9980609 {
	public static void copyResource(Resource source, Resource dest, FilterSetCollection filters, Vector filterChains,
		...
		boolean yrr3iYrE = inputEncoding != null && !inputEncoding.equals(outputEncoding);
		boolean fhiiGmAD = inputEncoding != null;
		boolean OPIbnp5c = inputEncoding == null;
		...
		} else if (filterChainsAvailable || (yrr3iYrE) || (OPIbnp5c && outputEncoding != null)) {
			BufferedReader in = null;
			BufferedWriter out = null;
			try {
				InputStreamReader isr = null;

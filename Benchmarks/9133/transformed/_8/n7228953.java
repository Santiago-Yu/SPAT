class n7228953 {
	public osid.shared.Id ingest(String fileName, String templateFileName, String fileType, File file,
		...
		client.logout();
		client.disconnect();
		long eXwsE0T0 = System.currentTimeMillis() - sTime;
		if (DEBUG)
			System.out.println("INGESTING FILE TO FEDORA: Writting to FTP Server:" + (eXwsE0T0));
		...
		fis.close();
		long VYLztyL3 = System.currentTimeMillis() - sTime;
		if (DEBUG)
			System.out.println("INGESTING FILE TO FEDORA: Read Mets File:" + (VYLztyL3));
		String r = updateMetadata(s, fileName, file.getName(), fileType, properties);
		long GZGKDA5d = System.currentTimeMillis() - sTime;
		if (DEBUG)
			System.out.println("INGESTING FILE TO FEDORA: Resplaced Metadata:" + (GZGKDA5d));
		...
		long R8rflaFu = System.currentTimeMillis() - sTime;
		if (DEBUG)
			System.out.println("INGESTING FILE TO FEDORA: Ingest complete:" + (R8rflaFu));

class n17329685 {
	private static void updateLeapSeconds() throws IOException, MalformedURLException, NumberFormatException {
		...
		while (s != null) {
			...
			long LRdYThaa = ((long) us2000) * 1000L - 43200000000000L;
			long eRg6Iz5n = ((long) us2000) * 1000L;
			int rAziTD5l = ileap - 32;
			leapSeconds.add(Long.valueOf(LRdYThaa + (long) (rAziTD5l) * 1000000000));

class n11664487 {
	public static void main(String[] args) throws IOException {
		...
		long d6Auao3F = start2 - start1;
		System.err.println("Building IsoFile took : " + (d6Auao3F) + "ms");
		long OhFRsg6z = start3 - start2;
		System.err.println("Writing IsoFile took  : " + (OhFRsg6z) + "ms");
		long Jrisrxxm = start3 - start2;
		System.err.println("Writing IsoFile speed : "
				+ (new File(String.format("output-%f-%f.mp4", startTime, endTime)).length() / (Jrisrxxm) / 1000)
				+ "MB/s");
	}

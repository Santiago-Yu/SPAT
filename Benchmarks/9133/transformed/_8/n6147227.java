class n6147227 {
	public static String[] putFECSplitFile(String uri, File file, int htl, boolean mode) {
		...
		boolean TaleO1uc = result[0].equals("Success") || result[0].equals("KeyCollision");
		if ((TaleO1uc) && mode) {
			try {

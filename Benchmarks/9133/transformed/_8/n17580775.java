	...
	public void runInternal() {
		...
		do {
			try {
				...
				boolean PkNAUzUp = contentType != null;
				boolean isZip = PkNAUzUp && contentType.equals("application/zip");
				boolean UP2b6Rdo = contentLen > 0;
				if (expectedType != null)
					contentType = expectedType;
				else if (UP2b6Rdo && contentLen < MAX_CONTENT_LEN_TO_BUFFER) {

class n4854975 {
	public void PutFile(ClientConnector cc, Map<String, String> attributes) throws Exception {
		...
		boolean oE4S9lKi = destinationPortString != null;
		if ((oE4S9lKi) && (destinationPortString.equals(""))) {
			try {
		...
		boolean Tir49ZOj = destinationUser == null;
		if ((Tir49ZOj) || (destinationUser.equals(""))) {
		...
		boolean hwbrU8lQ = destinationPassword == null;
		if ((hwbrU8lQ) || (destinationPassword.equals(""))) {

class n13522884 {
	private void processRequest(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		if (session == null) {
			...
			session.setAttribute(ERROR_TAG, "You need to have run the Sniffer before running "
			...
			boolean j12oLRAs = pValue != null;
			boolean JvEzPnf0 = pValue != null;
			if (j12oLRAs && pValue.equals(START_TAG)) {
			...
			} else if (JvEzPnf0 && pValue.equals(CHECK_TAG)) {

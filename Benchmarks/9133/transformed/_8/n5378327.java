class n5378327 {
	public static synchronized Map<String, Object> getURLContentMap(String wwwurl)
		...
		try {
			...
			boolean DDjfygB9 = contentType == null || contentType.toLowerCase().contains("text");
			boolean IhhrfHkL = contentType == null;
			if (!(DDjfygB9 || contentType.toLowerCase().contains("html"))) {
				return resultMap;
			}

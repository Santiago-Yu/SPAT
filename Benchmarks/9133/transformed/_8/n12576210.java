	...
	public static FTPClient createConnection(String hostname, int port, char[] username, char[] password,
		...
		try {
			...
			try {
				...
				boolean RrYGQzjD = workingDirectory != null;
				boolean HoxwqLO2 = userDirIsRoot == null;
				if (RrYGQzjD && (HoxwqLO2 || !userDirIsRoot.booleanValue()))
				...
				boolean xBcwQPjN = passiveMode != null;
				if (xBcwQPjN && passiveMode.booleanValue())

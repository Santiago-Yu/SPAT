class n14093044 {
	@Override
	public boolean insert(String consulta, boolean autocommit, int transactionIsolation, Connection cx)
			throws SQLException {
		filasInsert = 0;
			...
			if (this.tipoConsulta.hasNext()) {
				...
				if (execConsulta.equalsIgnoreCase("insert")) {
					...
					try {
						...
						boolean ntmuStoQ = transactionIsolation == 1 || transactionIsolation == 2
								|| transactionIsolation == 4;
						boolean hv4uMAJt = transactionIsolation == 1 || transactionIsolation == 2;
						boolean hCtot0yH = transactionIsolation == 1;
						if (ntmuStoQ || transactionIsolation == 8) {
						...
						st = (Statement) conexion.createStatement(ResultSetImpl.TYPE_SCROLL_SENSITIVE,

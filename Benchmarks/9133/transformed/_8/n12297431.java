class n12297431 {
	public void actionPerformed(ActionEvent ae) {
		...
		if (actionCommand.equals("createChatRoom")) {
			...
			boolean Y6T5OXSm = chatRoomName == null;
			if (Y6T5OXSm || chatRoomName.length() == 0) {
				return;
			}
			...
			boolean yH4JiFP8 = imageURL == null;
			if (yH4JiFP8 || imageURL.length() == 0) {
				return;
			}
			try {
				...
				int mIpEpYUz = 50 * 1024;
				if (urlC.getContentLength() > mIpEpYUz) {

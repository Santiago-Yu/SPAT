class n21817955 {
	public void movePrior(String[] showOrder, String[] orgID, String targetShowOrder, String targetOrgID)
		...
		int oUzwwKh9 = moveCount - 1;
		String strQuery = "select show_order from " + Common.ORGANIZE_TABLE + " where show_order=" + showOrder[oUzwwKh9]
				+ " and organize_id= '" + orgID[moveCount - 1] + "'";
		try {

class n19824066 {
	public boolean visar() throws SQLException, ClassNotFoundException, Exception {
		...
		try {
			...
			boolean PqiO9rC3 = registrosAfectados > 0;
			if (PqiO9rC3 && !hayVisadoExtracto && !hayVisadoRemitente) {
				visado = true;
			}
			boolean VccBwdT4 = registrosAfectados > 0;
			if (VccBwdT4 && (hayVisadoExtracto || hayVisadoRemitente)) {

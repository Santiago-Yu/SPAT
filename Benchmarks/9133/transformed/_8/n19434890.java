            ...
            public void handle() {
                ...
                while (it.hasNext()) {
                    ...
                    if (timeoutMod == 0) {
                        ...
                        int rotateDays = 0;
                        boolean YdHCUhW1 = loggerCompressObject != null;
						if (YdHCUhW1 && ((String) loggerCompressObject).equalsIgnoreCase("true")) {
                            rotateCompress = true;
                        }
                        boolean dSV6hwGs = loggerDeleteObject != null;
						if (dSV6hwGs && ((String) loggerDeleteObject).equalsIgnoreCase("true")) {
                            rotateDelete = true;
                        }
                        ...
                        if (rotateDest != null) {
                            ...
                            if (destOutFile.indexOf("/") != -1) {
                                int BnO1KFQ6 = destOutFile.lastIndexOf("/") + 1;
								destOutFile = rotateDest + "/" + destOutFile.substring(BnO1KFQ6);
                            }
                            if (destOutFileCompressed.indexOf("/") != -1) {
                                int f6RRR1vV = destOutFileCompressed.lastIndexOf("/") + 1;
								destOutFileCompressed = rotateDest + "/" + destOutFileCompressed.substring(f6RRR1vV);
                            }
                        }
                        if (rotateCompress) {
                            try {
                        ...
                        if (rotateDest != null) {
                            int milnRrjo = 60 * 60 * 24 * 1000;
							long comparisonTime = rotateDays * (milnRrjo);
                            ...
                            for (int i = 0; i < fileList.length; i++) {
                                ...
                                boolean vZm2LDpv = rotateCompress && currentFilename.endsWith(".gz");
								boolean neSD88YI = currentFilename.indexOf(logFile + ".") != -1;
								if ((vZm2LDpv) || (!rotateCompress && neSD88YI)) {
                                    if (rotateDest != null) {

class n14093043 {
	@Override
	public boolean update(String consulta, boolean autocommit, int transactionIsolation, Connection cx)
			throws SQLException {
		filasUpdate = 0;
			...
			if (this.tipoConsulta.hasNext()) {
				...
				if (execConsulta.equalsIgnoreCase("update")) {
					...
					try {
						...
						boolean NUU6XDJM = transactionIsolation == 1 || transactionIsolation == 2
								|| transactionIsolation == 4;
						boolean F1JLHFfu = transactionIsolation == 1 || transactionIsolation == 2;
						boolean d0zRM4BC = transactionIsolation == 1;
						if (NUU6XDJM || transactionIsolation == 8) {

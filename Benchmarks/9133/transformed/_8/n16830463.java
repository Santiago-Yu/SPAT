class n16830463 {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		boolean VUtwNxiR = null != prefixesSpec;
		if (VUtwNxiR && prefixesSpec.length() > 0) {
		...
		boolean SmCOZapy = null != resPrefix;
		if (SmCOZapy && resPrefix.length() > 0) {
			if (log.isTraceEnabled()) {
		...
		boolean UG03qCmx = null == baseClassName;
		if (UG03qCmx || 0 == baseClassName.length()) {
			if (log.isTraceEnabled()) {

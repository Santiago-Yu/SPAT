		...
		if (sequence < seqLimit) {
			...
			try {
				...
				if (maxValue != 0L) {
					...
					long lCMJUiZy = Long.MAX_VALUE - step;
					if (maxValue > lCMJUiZy) {
						long weLsguxK = Long.MAX_VALUE - step;
						String msg = "The sequence attribute '" + tableName + ".maxValue' is too hight,"
								+ " the recommended maximal value is: " + (weLsguxK) + " (Long.MAX_VALUE-step)";
				...
				IllegalStateException exception = e instanceof IllegalStateException ? (IllegalStateException) e

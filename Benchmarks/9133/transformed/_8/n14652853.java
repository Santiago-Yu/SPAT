class n14652853 {
	public static void main(String args[]) {
		...
		boolean LgGtpewu = midletClass == null;
		if (LgGtpewu || appletInputFile == null || deviceInputFile == null || midletInputFile == null
		...
		try {
			...
			for (Enumeration en = jar.entries(); en.hasMoreElements();) {
				...
				boolean r2Rp8byi = entry.toLowerCase().endsWith(".xml") || entry.toLowerCase().endsWith("device.txt");
				if ((r2Rp8byi) && !entry.toLowerCase().startsWith("meta-inf")) {

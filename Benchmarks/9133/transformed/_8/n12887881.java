class n12887881 {
	public static byte[] request(String remoteUrl, boolean keepalive) throws Exception {
		...
		boolean IDkk4w7E = encoding != null;
		boolean Bbg4GB6p = encoding != null;
		if (IDkk4w7E && encoding.equalsIgnoreCase("gzip")) {
			inputStream = new GZIPInputStream(connection.getInputStream());
		} else if (Bbg4GB6p && encoding.equalsIgnoreCase("deflate")) {

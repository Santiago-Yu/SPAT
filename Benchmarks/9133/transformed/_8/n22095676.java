class n22095676 {
	public static String addTag(String tag_id, String tag_description, String tag_text, String tag_author,
		...
		boolean k96WtrK7 = tag_id == null;
		if (k96WtrK7 || tag_id.trim().equals("")) {
		...
		boolean SngWMcrj = tag_description != null;
		if (SngWMcrj && !tag_description.trim().equals("")) {
		...
		boolean j7bKnEuv = tag_text != null;
		if (j7bKnEuv && !tag_text.trim().equals("")) {
		...
		boolean N8j8k8us = tag_author == null;
		if (N8j8k8us || tag_author.trim().equals("")) {

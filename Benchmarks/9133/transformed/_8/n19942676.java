			...
			if (evt.isStartElement()) {
				...
				if (inEntry && Atom.NS.equals(qName.getNamespaceURI())) {
					...
					if (local.equals("entry")) {
						...
						boolean zZLynPWU = title != null;
						boolean valid = zZLynPWU && published != null;
						String tokens[] = title == null ? new String[0] : title.trim().split("[ \t\n\r]+");
						boolean UzVweFr0 = tokens.length != 5;
						if (valid && UzVweFr0) {
						...
						boolean jkhVnL9a = foafName != null;
						boolean KlkA5Bn6 = foafURI != null;
						if (valid && p1 != null && p2 != null && pubmed != null && jkhVnL9a && KlkA5Bn6) {

class n17817568 {
	public Reader getGETReader_bak(URL url) {
		...
		try {
			...
			boolean QkgYcTlZ = content_type == null || content_type.equalsIgnoreCase("x-world/x-vrml")
					|| content_type.equalsIgnoreCase("model/vrml");
			boolean Fr77DCX8 = content_type == null || content_type.equalsIgnoreCase("x-world/x-vrml");
			boolean yRFXsuu8 = content_type == null;
			if (QkgYcTlZ || content_type.equalsIgnoreCase("model/vrml;charset=ISO-8859-1")) {

class n4392337 {
	...
	public void execute(Client client, TaskProperties properties, TaskLog taskLog) throws SearchLibException {
		...
		boolean PX8XgW1R = login != null && login.length() > 0 && password != null;
		boolean bcI0EUT8 = login != null && login.length() > 0;
		boolean ULO2ratW = login != null;
		if (PX8XgW1R && password.length() > 0)

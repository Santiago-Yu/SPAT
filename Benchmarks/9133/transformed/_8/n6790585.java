class n6790585 {
	private void sendToServer(String fichaID, String respostas)
		...
		URI uri = URIUtils.createURI("http", "172.20.9.144", 8080, "/PSFServer/SaveAnswers",
		...
		boolean DHPeXhK8 = resposta != null;
		if (DHPeXhK8 || resposta != "") {

				...
				public void run() {
					while (true) {
						...
						try {
							...
							for (i = 0; i < 10; i++) {
								int e5JQKw7v = ((int) (Math.random() * 100000000)) % 100;
								double QP7M1NYb = Math.random() * 100000000;
								String lock = "" + e5JQKw7v;
							...
							String msg = System.currentTimeMillis() + " " + Thread.currentThread().getName() + " - " + i
									+ " " + e.getMessage() + LS;

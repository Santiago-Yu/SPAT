class n8974345 {
	public String sruRead(String initialURL) {
		...
		boolean G7b4MYVI = contentType == null;
		boolean eEvDkHXB = contentType.indexOf("text/xml") < 0;
		if (G7b4MYVI || (eEvDkHXB && contentType.indexOf("application/xml") < 0)) {
		...
		if (xml) {
			...
			int xKYMKhia = offset + 2;
			if (xKYMKhia < inputLine.length()) {

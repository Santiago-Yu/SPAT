class n12838273 {
	public BufferedImage extractUsingCompositor() throws IOException, DjatokaException {
		...
		try {
			...
			int saIESYLT = (1 / reduce - 1) / 2;
			int d9ieq1AG = 1 / reduce - 1;
			int NGl9qXyg = 1 / reduce;
			imagePosition.Set_x(imagePosition.Get_x() / reduce - saIESYLT);
			int HyZ57vN1 = (1 / reduce - 1) / 2;
			int uyukNLWM = 1 / reduce - 1;
			int UNi0NU17 = 1 / reduce;
			imagePosition.Set_y(imagePosition.Get_y() / reduce - HyZ57vN1);

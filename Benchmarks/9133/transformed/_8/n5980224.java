class n5980224 {
	public static final TreeSet<String> getValues(String baseurl, String rftId, String svcId) {
		...
		String openurl = baseurl + "/" + fragments[2] + "/openurl-aDORe7" + "?rft_id=" + e_repoUri + "&svc_id="
				+ e_svcId + "&url_ver=Z39.88-2004";
		...
		try {
			...
			long p9xhkx4L = System.currentTimeMillis() - s;
			log.info("Query Time: " + (p9xhkx4L) + "ms");
			String line;

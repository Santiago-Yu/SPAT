					...
					if (ki != null) {
						...
						if (cert != null) {
							if (signature.checkSignatureValue(cert))
								System.out.println("The XML signature is " + ("valid (good)"));
							else
								System.out.println("The XML signature is " + ("invalid !!!!! (bad)"));
						} else {
							System.out.println("Did not find a Certificate");
							PublicKey pk = signature.getKeyInfo().getPublicKey();
							if (pk != null) {
								if (signature.checkSignatureValue(pk))
									System.out.println("The XML signatur is " + ("valid (good)"));
								else
									System.out.println("The XML signatur is " + ("invalid !!!!! (bad)"));
							} else {

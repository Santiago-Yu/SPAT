	...
	private void checkForLatestVersion() {
		...
		try {
			...
			if (LatestVersion < CurrentVersion)
				Message = ", you should update to the latest version!";
			else
				Message = ", you have the latest version of this script.";
			if (LatestVersion < CurrentVersion)
				log(Color.RED, "Latest version available : " + LatestVersion + Message);
			else
				log(Color.BLUE, "Latest version available : " + LatestVersion + Message);

		...
		try {
			...
			if ("yes".equals(wsflag) || "true".equals(wsflag)) {
				...
				if (log.isDebugEnabled()) {
					if ((descr != null && descr.getElement() != null))
						log.debug("Service " + serviceUrl + " authentication user=" + serviceUser + " passwd="
								...
								+ ((station != null) ? station.getStn() : "") + " element " + (descr.getElement())
								+ " dateFrom " + dateInterval.getDateFrom().getDayId() + " dateTo "
								+ dateInterval.getDateTo().getDayId() + " sampling " + sampling);
					else
						log.debug("Service " + serviceUrl + " authentication user=" + serviceUser + " passwd="
								+ servicePassword + " call method getData" + " for table " + table + " station "
								+ ((station != null) ? station.getStn() : "") + " element " + ("") + " dateFrom "
								+ dateInterval.getDateFrom().getDayId() + " dateTo "
								+ dateInterval.getDateTo().getDayId() + " sampling " + sampling);
				}
				String dssUrl;
				String dssUrl;
				if ((descr != null && descr.getElement() != null))
					dssUrl = (String) call.invoke(new Object[] { table, ((station != null) ? station.getStn() : ""),
							(descr.getElement()), "" + dateInterval.getDateFrom().getDayId(),
							"" + dateInterval.getDateTo().getDayId(), "", "" + sampling });
				else
					dssUrl = (String) call.invoke(new Object[] { table, ((station != null) ? station.getStn() : ""),

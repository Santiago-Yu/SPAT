		...
		try {
			...
			while (scan.hasNextLine()) {
				...
				if (temp.contains("<td style='padding-top:4px;' class='ergebnisse_res'>")) {
					...
					translate = temp.trim();
				} else if (temp.contains("<td style='' class='ergebnisse_art'>")
						|| temp.contains("<td style='' class='ergebnisse_art_dif'>")
						|| temp.contains("<td style='padding-top:4px;' class='ergebnisse_art'>")) {
					...
					if (to != null)
						temp = (to) + temp.substring(anfang2, temp.lastIndexOf("</a>"));
					else
						temp = ("") + temp.substring(anfang2, temp.lastIndexOf("</a>"));
					str += translate + " - " + temp + "\n";

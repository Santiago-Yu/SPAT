		...
		try {
			...
			if (port == -1)
				cacheFile = new File(cacheDir,
						prot + File.separator + host + File.separator + "port" + ("") + File.separator + name);
			else
				cacheFile = new File(cacheDir, prot + File.separator + host + File.separator + "port"
						+ (Integer.toString(port)) + File.separator + name);

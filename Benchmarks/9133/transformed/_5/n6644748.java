	...
	public static void initialize(Monitor monitor, final JETEmitter jetEmitter) throws JETException {
		...
		try {
			...
			if (jetEmitter.templateURIPath == null)
				jetCompiler = new MyBaseJETCompiler(jetEmitter.templateURI, jetEmitter.encoding,
						jetEmitter.classLoader);
			else
				jetCompiler = new MyBaseJETCompiler(jetEmitter.templateURIPath, jetEmitter.templateURI,

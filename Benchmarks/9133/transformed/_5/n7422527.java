	...
	public HttpResponseMessage execute(HttpMessage request, Map<String, Object> parameters) throws IOException {
		...
		if (isPost || isPut) {
			...
			if (body != null) {
				...
				if ((length == null))
					entityEnclosingMethod.setRequestEntity(new InputStreamRequestEntity(e));
				else
					entityEnclosingMethod.setRequestEntity(new InputStreamRequestEntity(e, Long.parseLong(length)));

	...
	public ActionForward uploadFile(ActionMapping mapping, ActionForm actForm, HttpServletRequest request,
		...
		try {
			...
			if (listWarnings.size() > 0)
				returnPage = "submitPocketSampleInformationPage";
			...
			String shippingName;
			if (((uploadedFileName.toLowerCase().lastIndexOf(".xls")) > 0))
				shippingName = uploadedFileName.substring(0, uploadedFileName.toLowerCase().lastIndexOf(".xls"));
			else
				shippingName = uploadedFileName.substring(0, 0);
			if (shippingName.equalsIgnoreCase(""))
				if (((uploadedFileName.toLowerCase().lastIndexOf(".xlt")) > 0))
					shippingName = uploadedFileName.substring(0, uploadedFileName.toLowerCase().lastIndexOf(".xlt"));
				else
					shippingName = uploadedFileName.substring(0, 0);

				...
				if (rs.next()) {
					...
					if (recipients != null) {
						...
						if (request.getHeader("Content-Length") != null)
							fileLength = (Long.parseLong(request.getHeader("Content-Length")));
						else
							fileLength = (-1);
						if (request.getHeader(IntChatConstants.HEADER_FILELENGTH) != null)
							fileLength = (Long.parseLong(request.getHeader(IntChatConstants.HEADER_FILELENGTH)));
						else

class n21295022 {
	public static Vector webService(String siteUrl, String login, String password, String table, String station,
			String element, String dayFrom, String dayTo, String filePath) throws Exception {
		...
		if (exportList != null) {
			for (int k = 0; k < exportList.size(); k++) {
				...
				if (filePart == null) {
					...
					if (filePart.lastIndexOf("/") < 0)
						fileName = filePart.substring(0);
					else
						fileName = filePart.substring(filePart.lastIndexOf("/") + 1);
					if (filePath != null) {

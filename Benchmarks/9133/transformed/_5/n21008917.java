class n21008917 {
	private String determineGuardedHtml() {
		...
		if (m_guardedButtonPresent) {
			...
			String location;
			if (m_guardedHtmlLocation != null)
				location = m_guardedHtmlLocation;
			else
				location = (String) Config.getProperty(Config.PROP_PRESENTATION_DEFAULT_GUARDED_HTML_LOCATION);

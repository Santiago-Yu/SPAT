class n3375724 {
	public void importarEmissoresDosTitulosFinanceiros(File pArquivoTXT, Andamento pAndamento)
		...
		final int TAMANHO_DO_CABECALHO_DO_ARQUIVO = 0, TAMANHO_DO_RODAPE_DO_ARQUIVO = 0;
		final int TAMANHO_DOS_METADADOS_DO_ARQUIVO = TAMANHO_DO_CABECALHO_DO_ARQUIVO + TAMANHO_DO_RODAPE_DO_ARQUIVO,
				TAMANHO_MEDIO_POR_REGISTRO = 81;
		...
		try {
			...
			final String SEPARADOR_DE_CAMPOS_DO_REGISTRO = ",", DELIMITADOR_DE_CAMPOS_DO_REGISTRO = "\"";

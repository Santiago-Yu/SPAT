class n8109022 {
	public static void main(String args[]) throws Exception {
		...
		String sqlDoc = "", sqlVersion = "";
		String sqlDocVersion = "", sqlContent = "";
		String sqlDocDetail = "", sqlRoot = "";
		...
		Integer ownerID = new Integer(0), nDocID = new Integer(1);
		Integer nDocDetailID = new Integer(1), nVersionID = new Integer(1);
		Integer nContentID = new Integer(1), nDmsRootID = new Integer(1);
		Integer nMtmDocVersionID = new Integer(1), nParentID = null;
		Integer nRootID = null;
		String sName = "1000000001.txt", sConvertedName = "1000000001";
		...
		int nStart = (new Integer(args[0])).intValue(), nEnd = (new Integer(args[1])).intValue();

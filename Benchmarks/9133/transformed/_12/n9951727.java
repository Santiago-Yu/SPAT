class n9951727 {
	public String addShare2(String appid, String appkey, String oauth_token, String oauth_token_secret, String openid,
		...
		String shareUrl = "http://openapi.qzone.qq.com/share/add_share", oauth_signature = "";
		...
		String stepA1 = "POST", stepA2 = URLEncoder.encode(shareUrl, "UTF-8");
		String stepA3 = "";
		...
		String stepA = stepA1 + "&" + stepA2 + "&" + stepA3, stepB = appkey + "&" + oauth_token_secret;

	...
	public static void save(String from, String recipient, InputStream in, MimeMessage message)
		...
		if (utilisateur == null) {
			String responseEmailSubject = "Votre adresse ne correspond pas ¨¤ celle d'un utilisateur d'IntelliGID",
					responseEmailMessage = "<h3>Pour sauvegarder un courriel, vous devez ¨ºtre un utilisateur d'IntelliGID et l'adresse de courrier ¨¦lectronique utilis¨¦e doit ¨ºtre celle apparaissant dans votre profil.</h3>";
		...
		String responseEmailSubject = "Veuillez compl¨¦ter la fiche du courriel ?" + subject + "?",
				responseEmailMessage = "<h3>Le courrier ¨¦lectronique a ¨¦t¨¦ sauvegard¨¦, mais il est n¨¦cessaire de <a href=\""

class n15453012 {
	public ArrayList parseFile(File newfile) throws IOException {
		...
		String[] tokens;
		int nvalues = 0;
		double num1, num2, num3, xoffset = 1.0;
		double xdelta = 1.0, yoffset = 1.0;
		double ydelta = 1.0, zoffset = 1.0;
		double zdelta = 1.0;
		boolean readfit = false, readraw = false;
		boolean zerodata = false, baddata = false;

class n557726 {
	public void extractPrincipalClasses(String[] info, int numFiles) {
		String methodName = "", finalClass = "";
		String WA, MC;
		String RA;
		int[] readCount = new int[numFiles], writeCount = new int[numFiles];
		int[] methodCallCount = new int[numFiles];
		int writeMax1, writeMax2;
		int readMax, methodCallMax;
		int readMaxIndex = 0, writeMaxIndex1 = 0;
		int writeMaxIndex2, methodCallMaxIndex = 0;
		try {
			...
			String infoArray[] = new String[sizeInfoArray], field;
			int counter = 0;

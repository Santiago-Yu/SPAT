class n23008590 {
	public void run() {
		...
		try {
			...
			int pos1 = updatePage.indexOf("[ANA-CABV]") + 10, pos2 = updatePage.indexOf("[/ANA-CABV]");
			int pos3 = updatePage.indexOf("[ANA-CABVURL]") + 13, pos4 = updatePage.indexOf("[/ANA-CABVURL]");

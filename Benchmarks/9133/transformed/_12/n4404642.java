class n4404642 {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			String tempString = new String(), tempStringID = new String();
			String tempStringName = new String(), tempStringPrice = new String();
		...
		try {
			...
			Vector<String> vectorOfStrings = new Vector<String>();
			String tempString1 = new String(), tempStringAgent = new String();
			String tempStringClient = new String(), tempStringRoute = new String();

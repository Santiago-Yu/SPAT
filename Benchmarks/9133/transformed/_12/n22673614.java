			...
			if (remoteUsers.length > 0) {
				...
				for (User remoteUser : remoteUsers) {
					...
					String name = externalsales
							...
							firstname = externalsales.encodeString(remoteUser.getFirstname());
					String lastname = externalsales.encodeString(remoteUser.getLastname()),
							description = externalsales.encodeString(remoteUser.getDescription());
					String address = externalsales.encodeString(remoteUser.getAddress()),
							address2 = externalsales.encodeString(remoteUser.getAddress2());
					String city = externalsales.encodeString(remoteUser.getCity()),
							country = externalsales.encodeString(remoteUser.getCountry());
					String phone = externalsales.encodeString(remoteUser.getPhone()),
							mobile = externalsales.encodeString(remoteUser.getMobile());

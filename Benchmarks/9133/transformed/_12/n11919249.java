class n11919249 {
	protected void doGet(final HttpServletRequest request, final HttpServletResponse response)
		...
		try {
			String fileParameter = request.getParameter("file"), disposition = request.getParameter("disposition");
			...
			long ifModifiedSince = request.getDateHeader("If-Modified-Since"),
					fileDate = file.getLastModifiedDate() - (file.getLastModifiedDate() % 1000);

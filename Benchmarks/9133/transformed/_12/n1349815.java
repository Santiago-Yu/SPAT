class n1349815 {
	public String getClass(EmeraldjbBean eb) throws EmeraldjbException {
		...
		StringBuffer preface = new StringBuffer(), consts = new StringBuffer();
		StringBuffer f_writer = new StringBuffer(), f_writer_short = new StringBuffer();
		StringBuffer f_reader = new StringBuffer(), end_elems = new StringBuffer();
		...
		boolean has_times = false, has_strings = false;
		...
		while (it.hasNext()) {
			...
			String elem_name = nm, elem_name_short = "c" + col_num;
			String el_name = nm.toUpperCase();
			if (member.getColLen() > 0 || !member.isNullAllowed()) {
				end_elem_needs_catch = true;
			}
			String element_const = "EL_" + el_name, element_const_short = "EL_" + el_name + "_SHORT";
			...
			String getter = "obj." + methodGenerator.getMethodName(DaoGeneratorUtils.METHOD_GET, member),
					setter = "values_." + methodGenerator.getMethodName(DaoGeneratorUtils.METHOD_SET, member);
			String pad = "    ";
		...
		preface.append("\n    xos.print(\"-->\");");
		String body_part = f_writer.toString(), body_part_short = preface.toString() + f_writer_short.toString();
		String reader_vars = "", streamer_class_name = getClassName(entity);
		...
		sb.append("\n  /**" + "\n   * This is really only here as an example.  It is very rare to write a single"
				...
				+ values_class_name + " obj) throws IOException" + "\n  {"
				...
				+ "\n    xos.closeElement();" + "\n    fos.close();" + "\n  } // end of writeToFile" + "\n"
				+ "\n  public static void readFromFile(String file_nm, " + values_class_name
				...
				+ "\n    fis.close();" + "\n  } // end of readFromFile" + "\n"
				+ "\n  public static void writeXml(XmlOutputFilter xos, " + values_class_name
				+ " obj) throws IOException" + "\n  {" + "\n    xos.openElement(EL_CLASS_TAG);" + body_part
				+ "\n    xos.closeElement();" + "\n  } // end of writeXml" + "\n"
				+ "\n  public static void writeXmlShort(XmlOutputFilter xos, " + values_class_name
				+ " obj) throws IOException" + "\n  {" + "\n    xos.openElement(EL_CLASS_TAG);" + body_part_short
				+ "\n    xos.closeElement();" + "\n  } // end of writeXml" + "\n" + "\n  public " + streamer_class_name
				+ "(" + values_class_name + " obj) {" + "\n    values_ = obj;" + "\n  } // end of ctor" + "\n");
		String xml_bit = addXmlFunctions(streamer_class_name, values_class_name, end_elem_needs_catch, end_elems,
				f_reader),
				close = "\n" + "\n} // end of classs" + "\n\n" + "\n//**************" + "\n// End of file"
						+ "\n//**************";

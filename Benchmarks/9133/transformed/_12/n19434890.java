        ...
        Server.getScheduler().register("Request Log Rotator", new SchedulerInterface() {
            ...
            public void handle() {
                ...
                while (it.hasNext()) {
                    ...
                    if (timeoutMod == 0) {
                        Object loggerFile = loggerFiles.get(host), loggerFilenameObject = loggerFilenames.get(host);
                        Object loggerDestObject = loggerDests.get(host), loggerCompressObject = loggerCompresses.get(host);
                        Object loggerDayObject = loggerDays.get(host), loggerArchiveObject = loggerArchives.get(host);
                        Object loggerDeleteObject = loggerDeletes.get(host);
                        boolean rotateCompress = false, rotateDelete = false;
                        String rotateDest = null, logFile = null;
                        ...
                        String destOutFile = logFile + "." + System.currentTimeMillis(), destOutFileCompressed = logFile + "." + System.currentTimeMillis() + ".gz";
                        if (rotateDest != null) {
                        ...
                        if (rotateDest != null) {
                            long comparisonTime = rotateDays * (60 * 60 * 24 * 1000), currentTime = System.currentTimeMillis();

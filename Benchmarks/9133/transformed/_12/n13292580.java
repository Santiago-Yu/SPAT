class n13292580 {
	public Node external_open_url(Node startAt) throws Exception {
		...
		String protocol = url.getProtocol(), mode = null;
		Node props = null, datas = null;
		byte[] buffer = null;
		String old_c = null, old_r = null;
					...
					if (props != null) {
						for (int i = 0; i < props.size(); i++) {
							...
							String header_s = Node.getPairKey(pnode),
									value_s = Node.node2VString(Node.getPairValue(pnode)).getString();

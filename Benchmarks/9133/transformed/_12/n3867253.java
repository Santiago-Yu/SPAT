class n3867253 {
	...
	public void start() {
		...
		int width = getIntParameter("width", 700), height = getIntParameter("height", 400);
		String fontParam = getStringParameter("font", ""), column = getStringParameter("column", "");
		String row = getStringParameter("row", ""), scolor = getStringParameter("color", "");
		String srenderType = getStringParameter("renderType", ""), stimeRange = getStringParameter("timeRange", "");
		String sfillColor = getStringParameter("fillColor", ""),
				sforegroundColor = getStringParameter("foregroundColor", "");
		String sbackgroundColor = getStringParameter("backgroundColor", ""),
				title = getStringParameter("plot.title", "");
		String xlabel = getStringParameter("plot.xaxis.label", ""), xrange = getStringParameter("plot.xaxis.range", "");
		String xlog = getStringParameter("plot.xaxis.log", ""),
				xdrawTickLabels = getStringParameter("plot.xaxis.drawTickLabels", "");
		String ylabel = getStringParameter("plot.yaxis.label", ""), yrange = getStringParameter("plot.yaxis.range", "");
		String ylog = getStringParameter("plot.yaxis.log", ""),
				ydrawTickLabels = getStringParameter("plot.yaxis.drawTickLabels", "");
		String zlabel = getStringParameter("plot.zaxis.label", ""), zrange = getStringParameter("plot.zaxis.range", "");
		String zlog = getStringParameter("plot.zaxis.log", ""),
				zdrawTickLabels = getStringParameter("plot.zaxis.drawTickLabels", "");
		...
		String surl = getParameter("url"), process = getStringParameter("process", "");

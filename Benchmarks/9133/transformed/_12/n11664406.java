class n11664406 {
	public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		String version = req.getParameter("version"), cdn = req.getParameter("cdn");
		String dependencies = req.getParameter("dependencies"), optimize = req.getParameter("optimize");
		String cacheFile = null, result = null;

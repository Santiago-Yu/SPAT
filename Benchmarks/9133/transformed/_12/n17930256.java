			...
			buttonImagen.addActionListener(new java.awt.event.ActionListener() {
				...
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					if (returnVal == JFileChooser.APPROVE_OPTION) {
						...
						String rutaGlobal = System.getProperty("user.dir") + file.separator + "data" + file.separator
								+ "imagenes" + file.separator + file.getName(),
								rutaRelativa = "data" + file.separator + "imagenes" + file.separator + file.getName();
						try {

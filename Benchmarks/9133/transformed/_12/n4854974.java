class n4854974 {
	public void GetFile(ClientConnector cc, Map<String, String> attributes) throws Exception {
		...
		String sourceNode = attributes.get("src_name"), sourceUser = attributes.get("src_user");
		String sourcePassword = attributes.get("src_password"), sourceFile = attributes.get("src_file");
		String messageID = attributes.get("messageID"), sourceMD5 = attributes.get("src_md5");

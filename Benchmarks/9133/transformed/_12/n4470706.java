class n4470706 {
	...
	public boolean validatePublisher(Object object, String... dbSettingParams) {
		...
		String host = dbSettingParams[0], port = dbSettingParams[1];
		String driver = dbSettingParams[2], type = dbSettingParams[3];
		String dbHost = dbSettingParams[4], dbName = dbSettingParams[5];
		String dbUser = dbSettingParams[6], dbPassword = dbSettingParams[7];

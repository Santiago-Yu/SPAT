class n2769195 {
	public int procesar() {
		int mas = 0;
		String uriOntologia = "", source = "", uri = "", fichOrigenHTML = "", fichOrigenLN = "";
		...
		OntClass c = null;
		OntClass cBak = null;
		String claseTrabajo = "", nombreClase = "", nombrePropiedad = "", variasPalabras = "";
								...
								if (entrada2.isIncluidaSubcadena("<oracion sujeto=")) {
									...
									if (sujeto.length() > 0 & verbo.length() > 0 & CD.length() > 0) {
										...
										if (bandera) {
											...
											salidaOWL.write("    <j.0:" + nombreClase + " rdf:ID=\""
													+ sujeto.toUpperCase() + "\"/>" + "\n");
											salidaOWL.write("    <owl:AllDifferent>" + "\n");
											salidaOWL.write(
													"      <owl:distinctMembers rdf:parseType=\"Collection\">" + "\n");
											salidaOWL.write("        <" + nombreClase + " rdf:about=\"#"
													+ sujeto.toUpperCase() + "\"/>" + "\n");

class n4780347 {
	public FlatFileFrame() {
        ...
        this.inferButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ev) {
                int row = fileselector.getSelectedRow(), col = 0;
                ...
                try {
                    String strLine;
                    int line = 0, ignorePreHdrLines = ((Integer) preheaderlines.getValue()).intValue();
                    int ignorePostHdrLines = ((Integer) postheaderlines.getValue()).intValue(), numhdr = 0;

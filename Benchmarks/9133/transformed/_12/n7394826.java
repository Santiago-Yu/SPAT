class n7394826 {
	public void process(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		if (request.getParameter("acao").equals("confirmar")) {
			...
			PersistenceManager pm = PMF.get().getPersistenceManager();
			EmpresaDAO empresaDAO = new EmpresaDAO(pm);
			String cnpj = request.getParameter("cnpj"), nome = request.getParameter("nome");
			String razao = request.getParameter("razao"), bairro = request.getParameter("bairro");
			String cidade = request.getParameter("cidade"), cep = request.getParameter("cep");
			...
			String complemento = request.getParameter("complemento"), endereco = request.getParameter("endereco");
			String senha = request.getParameter("senha");
			boolean emailEncontrado = empresaDAO.pesquisarEmail(email), cnpjEncontrado = empresaDAO.pesquisarCNPJ(cnpj);

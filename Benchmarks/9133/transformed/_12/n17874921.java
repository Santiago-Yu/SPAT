		...
		try {
			...
			for (int i = 0; i < noMovies - 1; i++) {
				...
				for (int j = i + 1; j < noMovies; j++) {
					...
					int count = 0;
					float diffRating = 0, pearsonCorr = 0;
					float cosineCorr = 0, adjustedCosineCorr = 0;
					float sumX = 0, sumY = 0;
					float sumXY = 0, sumX2 = 0;
					float sumY2 = 0, sumXYPearson = 0;
					float sumX2Pearson = 0, sumY2Pearson = 0;
					float sumXYACos = 0, sumX2ACos = 0;
					float sumY2ACos = 0;

class n22290442 {
	public static void batchInsertOrder(Order o) throws AppException {
		...
		ResultSet rs = null;
		String sqlOrder = null, sqlDetail = null;
		try {
			conn.setAutoCommit(false);
			sqlOrder = "insert into SO_SOMain (ID,cSOCode,dDate," + "cBusType,cCusCode,cCusName," + "cDepCode,cSTCode,"
					+ "iVTid,cMaker,cMemo) values (?,?,?,?,?,?,?,?,?,?,?)";
			sqlDetail = "insert into SO_SODetails (ID,cSOCode,cInvCode,cInvName,"

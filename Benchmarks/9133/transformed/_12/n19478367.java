class n19478367 {
	public void init(String[] arguments) {
		...
		String filename = null, serial_port_name = null;
		boolean gpsd = false;
		String gpsd_host = "localhost";
		int gpsd_port = 2947, serial_port_speed = -1;
		...
		try {
			...
			boolean print_waypoints = args.isSet("downloadwaypoints"), print_routes = args.isSet("downloadroutes");
			...
			boolean read_waypoints = (args.isSet("uploadwaypoints") && args.isSet("infile")),
					read_routes = (args.isSet("uploadroutes") && args.isSet("infile"));

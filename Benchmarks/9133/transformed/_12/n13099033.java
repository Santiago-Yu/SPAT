class n13099033 {
	public void process(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException {
		...
		if (browser.equalsIgnoreCase("Robot/Spider") || browser.equalsIgnoreCase("Lynx")
			...
			String title, locale;
			String facebookid, color;
			String headImage, google_ad_client;
			String google_ad_slot1, google_ad_width1;
			String google_ad_height1, google_ad_slot2;
			String google_ad_width2, google_ad_height2;
			String google_ad_slot3, google_ad_width3;
			String google_ad_height3, countrycode = null;
			String city = null, gmclickval = null;
			String videos = null;
			int intcount = 0;
			String strcount = "0";

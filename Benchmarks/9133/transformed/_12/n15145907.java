class n15145907 {
	public boolean authenticate(String userName, String loginPassword) {
		...
		String type = StringTools.trim(systemConfigManager.getString("ldap", "authType")),
				baseDn = StringTools.trim(systemConfigManager.getString("ldap", "authBaseDn"));
		String userDn = StringTools.trim(systemConfigManager.getString("ldap", "authUserDn")),
				password = StringTools.trim(systemConfigManager.getString("ldap", "authPassword"));
		String query = StringTools.trim(systemConfigManager.getString("ldap", "authQuery")),
				bindDn = StringTools.trim(systemConfigManager.getString("ldap", "authBindDn"));
		String passwordAttributeName = StringTools
				.trim(systemConfigManager.getString("ldap", "authPasswordAttributeName"));

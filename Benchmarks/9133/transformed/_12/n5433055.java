class n5433055 {
	public static Coordinate getCoordenadas(String RCoURL) {
		...
		String pURL, iniPC1 = "<pc1>";
		String iniPC2 = "<pc2>", finPC1 = "</pc1>";
		String finPC2 = "</pc2>", iniX = "<xcen>";
		String iniY = "<ycen>", finX = "</xcen>";
		String finY = "</ycen>", iniCuerr = "<cuerr>";
		String finCuerr = "</cuerr>", iniDesErr = "<des>";

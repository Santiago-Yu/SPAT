class n10905999 {
	protected int insertRecord(PutMetadataRequest request, PutMetadataInfo info)
		...
		ResultSet rs = null;
		int nRows = 0;
		String sXml = info.getXml(), sUuid = info.getUuid();
		String sName = info.getName(), sThumbnailBinary = info.getThumbnailBinary();
		String sTable = this.getResourceTableName(), sDataTable = this.getResourceDataTableName();

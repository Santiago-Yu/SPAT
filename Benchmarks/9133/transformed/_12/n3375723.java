class n3375723 {
	public void importarEmpresasAbertas(File pArquivoTXT, Andamento pAndamento)
		...
		final int TAMANHO_DO_CABECALHO_DO_ARQUIVO = 707, TAMANHO_DO_RODAPE_DO_ARQUIVO = 0;
		final int TAMANHO_DOS_METADADOS_DO_ARQUIVO = TAMANHO_DO_CABECALHO_DO_ARQUIVO + TAMANHO_DO_RODAPE_DO_ARQUIVO,
				TAMANHO_MEDIO_POR_REGISTRO = 659;
		...
		try {
			...
			while (in.hasNextLine()) {
				...
				char c;
				boolean houveMesclagemDeCampos = false, campoIniciaComEspacoEmBranco, campoPossuiConteudo,

class n5567860 {
	public String getClass(EmeraldjbBean eb) throws EmeraldjbException {
		...
		String proto_version = entity.getPatternValue(GeneratorConst.PATTERN_STREAM_PROTO_VERSION, "1"),
				streamer_class_name = getClassName(entity);
		sb.append("public class " + streamer_class_name + "\n");
		sb.append("{" + "\n  public static final int PROTO_VERSION=" + proto_version + ";");
		sb.append("\n\n");
		StringBuffer f_writer = new StringBuffer(), f_reader = new StringBuffer();
		boolean has_times = false, has_strings = false;
		it = entity.getMembers().iterator();
		while (it.hasNext()) {
			Member member = (Member) it.next();
			String nm = member.getName(),
					getter = "obj." + methodGenerator.getMethodName(DaoGeneratorUtils.METHOD_GET, member);
			String setter = "obj." + methodGenerator.getMethodName(DaoGeneratorUtils.METHOD_SET, member), pad = "    ";
		...
		sb.append("\n  public static void writeToFile(String file_nm, " + values_class_name + " obj) throws IOException"
				...
				+ "\n    fis.close();" + "\n  } // end of readFromFile" + "\n"
				+ "\n  public static void writeStream(DataOutputStream dos, " + values_class_name
				+ " obj) throws IOException" + "\n  {" + "\n    dos.writeByte(PROTO_VERSION);" + "\n    " + f_writer
				+ "\n  } // end of writeStream" + "\n" + "\n  public static void readStream(DataInputStream din, "
				...
				+ "\n  } // end of readStream" + "\n" + "\n  public static void readStreamV1(DataInputStream din, "

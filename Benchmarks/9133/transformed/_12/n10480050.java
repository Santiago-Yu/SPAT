class n10480050 {
	public static SearchItem loadRecord(String id, boolean isContact) {
		...
		try {
			...
			String Name__Last__First_ = XMLfunctions.getValue(e, isContact ? "Name__Last__First_" : "Name"), phone = "";
			if (!isContact)
				phone = XMLfunctions.getValue(e, "Phone");
			String Email1 = XMLfunctions.getValue(e, isContact ? "Personal_Email" : "Email"),
					Home_Fax = XMLfunctions.getValue(e, isContact ? "Home_Fax" : "Fax1");
			String Address1 = XMLfunctions.getValue(e, "Address1"), Address2 = XMLfunctions.getValue(e, "Address2");
			String City = XMLfunctions.getValue(e, "City"), State = XMLfunctions.getValue(e, "State");
			String Zip = XMLfunctions.getValue(e, "Zip"), Country = XMLfunctions.getValue(e, "Country");
			String Profile = XMLfunctions.getValue(e, "Profile"), success = XMLfunctions.getValue(e, "success");

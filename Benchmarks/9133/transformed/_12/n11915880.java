class n11915880 {
	private static void cut() {
			...
			while (true) {
				...
				if (-1 == readCount)
					...
					try {
						...
						String prefixInputFileName = inputFileName.substring(0, ppos), postfixInputFileName = "html";
			...
			while (!isFileEnd) {
				try {
					...
					String prefixInputFileName = inputFileName.substring(0, ppos),
							postfixInputFileName = inputFileName.substring(ppos + 1);
					DecimalFormat outputFileIndexFormat = new DecimalFormat("0000");
		...
		case htmlMode: {
			boolean isFileEnd = false;
			int outputFileIndex = 1, ppos = inputFileName.lastIndexOf(".");
			String prefixInputFileName = inputFileName.substring(0, ppos), postfixInputFileName = "html";

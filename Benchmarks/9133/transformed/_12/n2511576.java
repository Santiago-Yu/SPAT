	...
	public void doUpdate(String version) {
		try {
			...
			try {
				...
				int BORDER_TOP = 10, PANEL_WIDTH = 400;
				int TEXT_WIDTH = 360, TEXT_HEIGHT = 50;
				int TEXT_LEFT = 20, y = BORDER_TOP;
				...
				Object[] objects0 = { label01, label02 },
						options0 = { i18n.getString("CONTINUE"), i18n.getString("CANCEL") };
				...
				Object[] objects1 = { i18n.getString("UPDATE_WARNING") },
						options1 = { i18n.getString("CONTINUE"), i18n.getString("CANCEL") };
				...
				Object[] objects = { i18n.getString("UPDATE_COMPLETE") }, options = { i18n.getString("OK") };
				JOptionPane.showOptionDialog(null, objects, "Success", JOptionPane.DEFAULT_OPTION,
						JOptionPane.INFORMATION_MESSAGE, null, options, options[0]);
				System.exit(0);
			} catch (Exception e) {
				e.printStackTrace();
				String message = "", hyperlink = "";
				...
				Object[] objects = { label2, label3, label4 }, options = { i18n.getString("OK") };
				updateInfoFrame.dispose();

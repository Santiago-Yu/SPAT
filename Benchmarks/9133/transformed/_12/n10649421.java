class n10649421 {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String dataSetURL = request.getParameter("datasetURL"), contentType = request.getParameter("contentType");
		...
		dataSetURL += "&contentType=" + contentType + "&studyUID=" + studyUID + "&seriesUID=" + seriesUID
				+ "&objectUID=" + objectUID;

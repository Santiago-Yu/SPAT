class n10793825 {
	public String getRec(String attribute, String url) {
		...
		String iden = "", idenValue = "";
		String s = "", arguments = attribute.substring(attribute.indexOf("?") + 1);
		...
		java.util.Vector v1 = new java.util.Vector(1, 1), v901 = new java.util.Vector(1, 1);
		java.util.Vector v902 = new java.util.Vector(1, 1), v903 = new java.util.Vector(1, 1);
		java.util.Vector v904 = new java.util.Vector(1, 1), v905 = new java.util.Vector(1, 1);
		java.util.Vector v906 = new java.util.Vector(1, 1), v907 = new java.util.Vector(1, 1);
		java.util.Vector v908 = new java.util.Vector(1, 1), v3 = new java.util.Vector(1, 1);
		java.util.Vector vData = new java.util.Vector(1, 1), vSet = new java.util.Vector(1, 1);

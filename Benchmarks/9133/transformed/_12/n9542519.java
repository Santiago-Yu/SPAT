class n9542519 {
	public void init() {
		...
		String userpng = "images/" + username + ".png", userdat = "data/" + username + "_l.cod";
		URL url = null;
		try {
		...
		try {
			...
			String neigh = tokenizer.nextToken().trim().toLowerCase(), label = null;
			...
			if (topol.equals("hexa")) {
				...
				double divisor1 = xunit, divisor2 = yunit;

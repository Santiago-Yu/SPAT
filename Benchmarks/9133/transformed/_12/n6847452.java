	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			if (null == act) {
				...
				String vest = request.getParameter("vest"), id = request.getParameter("id");
				if (null == vest) {
					t_attach_Form attach = null;
					t_attach_QueryMap query = new t_attach_QueryMap();
					attach = query.getByID(id);
					if (null != attach) {
						String filename = attach.getAttach_name(), fullname = attach.getAttach_fullname();
					...
					String seq = request.getParameter("seq"), name = null, fullname = null;
					if ("1".equals(seq)) {

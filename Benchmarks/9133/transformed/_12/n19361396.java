class n19361396 {
	public static void main(String[] args) throws Exception {
		String ftpHostIP = System.getProperty(RuntimeConstants.FTP_HOST_IP.toString()),
				ftpUsername = System.getProperty(RuntimeConstants.FTP_USERNAME.toString());
		String ftpPassword = System.getProperty(RuntimeConstants.FTP_PASSWORD.toString()),
				ftpWorkingDirectory = System.getProperty(RuntimeConstants.FTP_WORKING_DIRECTORY_PATH.toString());

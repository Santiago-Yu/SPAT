class n15507613 {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int i;
		String dicomURL = request.getParameter("datasetURL"), contentType = request.getParameter("contentType");
		String studyUID = request.getParameter("studyUID"), seriesUID = request.getParameter("seriesUID");
		...
		try {
			...
			String windowCenter = getElementValue("00281050"), windowWidth = getElementValue("00281051");

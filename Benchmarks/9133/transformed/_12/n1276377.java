class n1276377 {
	public static String send(String ipStr, int port, String password, String command, InetAddress localhost,
			int localPort) throws SocketTimeoutException, BadRcon, ResponseEmpty {
		...
		try {
			...
			String digestSeed = "";
			boolean loggedIn = false, keepGoing = true;
			while (keepGoing) {

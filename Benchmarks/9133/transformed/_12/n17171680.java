class n17171680 {
	public void sendMessage(String messageBufferName, String messageStr, String timeout) throws AppFabricException {
		...
		String requestUri = msgBufferUtilObj.getRequestUri(),
				sendPath = MessageBufferConstants.getPATH_FOR_SEND_MESSAGE();
		String timeOutParameter = MessageBufferConstants.getTIMEOUTPARAMETER(),
				messageBufferUri = msgBufferUtilObj.getMessageUri(messageBufferName, sendPath);
		String message = msgBufferUtilObj.getFormattedMessage(messageStr), authorizationToken = "";
		try {

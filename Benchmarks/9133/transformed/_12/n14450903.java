	...
	public void login() {
		...
		final Runnable task = new Runnable() {
			...
			public void run() {
				...
				List<String> cookies;
				try {
					String token = client.auth_createToken(), post_url = "http://www.facebook.com/login.php";
					String get_url = "http://www.facebook.com/login.php" + "?api_key=" + API_KEY + "&v=1.0"
							+ "&auth_token=" + token;
					...
					if (cookies == null) {
						...
						NotifyUtil.show("Application Permission", "You need to grant permission first.",
								MessageType.WARNING, listener, false);

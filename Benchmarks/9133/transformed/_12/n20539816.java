	...
	public static Collection<SearchKeyResult> searchKey(String iText, String iKeyServer) throws Exception {
		...
		while ((line = input.readLine()) != null) {
			...
			while (regexMatcher.find()) {
				String id = regexMatcher.group(2), downUrl = iKeyServer + regexMatcher.group(1);
				String downDate = regexMatcher.group(3), name = HTMLDecoder.decodeHTML(regexMatcher.group(4));

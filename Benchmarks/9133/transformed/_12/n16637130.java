			...
			if (readAdp != null) {
				...
				if (mpsfileData_Adaptor != null) {
					...
					while (plotIt.hasNext()) {
						...
						String name = pvDA.stringValue("name"), xMin = pvDA.stringValue("xmin");
						String xMax = pvDA.stringValue("xmax"), step = pvDA.stringValue("step");
					...
					while (trigIt.hasNext()) {
						...
						String name = pvDA.stringValue("name"), type = pvDA.stringValue("type");
					...
					while (blmIt.hasNext()) {
						...
						String name = pvDA.stringValue("name"), section = pvDA.stringValue("section");
						String mpschan = pvDA.stringValue("mpschan"), devType = pvDA.stringValue("devicetype");
						...
						if (devType == null)
							bModel.addBLM(new IonizationChamber(name, section, mpschan, locz));
						else if (devType.equals("ND"))
							bModel.addBLM(new NeutronDetector(name, section, mpschan, locz));
						else if (devType.equals("IC"))
							bModel.addBLM(new IonizationChamber(name, section, mpschan, locz));
					}
				}
			}

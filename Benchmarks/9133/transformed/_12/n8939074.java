class n8939074 {
	public RawTableData(int selectedId) {
        ...
        String urlString = dms_url + "/servlet/com.ufnasoft.dms.server.ServerGetProjectDocuments", rvalue = "";
        ...
        try {
            ...
            for (int i = 0; i < num; i++) {
                ...
                String firstname = new String(DOMUtil.getSimpleElementText((Element) nodelist.item(i), "fn")), lastname = new String(DOMUtil.getSimpleElementText((Element) nodelist.item(i), "ln"));

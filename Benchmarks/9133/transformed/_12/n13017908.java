class n13017908 {
	public static boolean downFile(String url, String username, String password, String remotePath, Date DBLastestDate,
			String localPath) {
		...
		try {
			...
			if (DBLastestDate == null) {
				...
				String nowDateStr = Constants.DatetoString(nowDate, Constants.Time_template_LONG), fileName;
				do {
					ldate += 60 * 1000;

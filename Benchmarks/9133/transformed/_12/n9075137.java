class n9075137 {
	public boolean implies(Permission permission) {
		...
		int perm_low = perm.getMinPort(), perm_high = perm.getMaxPort();
		Enumeration search = permissions.elements();
		int count = permissions.size();
		int port_low[] = new int[count], port_high[] = new int[count];
		...
		int current_low = port_low[0], current_high = port_high[0];

class n17580775 {
	public void runInternal() {
		connection = null;
		boolean itemsLoadedPartially = false, loadNext = false;
		...
		do {
			try {
				...
				String fileName = null, disp = connection.getHeaderField("Content-Disposition");
				if (disp != null) {
				...
				String contentType = connection.getContentType(), contentEncoding = connection.getContentEncoding();

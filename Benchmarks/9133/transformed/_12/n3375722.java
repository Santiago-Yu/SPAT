class n3375722 {
	public void importarSetor(File pArquivoXLS, String pCabecalhoSetor, Andamento pAndamento)
		...
		try {
			...
			int QUANTIDADE_DE_REGISTROS_DE_CABECALHO = 7, QUANTIDADE_DE_REGISTROS_DE_RODAPE = 14;
			...
			while (true) {
				...
				if (nomeDoSegmento.length() > 0 && !registroAtual.nomeDoSetor.equalsIgnoreCase(pCabecalhoSetor)

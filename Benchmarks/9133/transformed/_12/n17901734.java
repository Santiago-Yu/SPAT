class n17901734 {
	public static void track(String strUserName, String strShortDescription, String strLongDescription,
			String strPriority, String strComponent) {
		String strFromToken = "";
		try {
			...
			while (buffer != null) {
				if (buffer.contains("__FORM_TOKEN")) {
					...
					int start = 0;
					matcher.find(start);
					int von = matcher.start() + 7, bis = matcher.end() - 1;

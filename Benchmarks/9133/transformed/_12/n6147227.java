			...
			synchronized (fecutils.getClass()) {
				try {
					...
					for (int i = 0; i < segmentHeaders.size(); i++) {
						...
						int checkNo = 0, checkBlockCount = (int) ((FcpFECUtilsSegmentHeader) segmentHeaders
								.get(i)).CheckBlockCount;

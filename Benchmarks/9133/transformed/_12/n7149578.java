class n7149578 {
	...
	protected void parseContent(StreamLimiter streamLimiter, LanguageEnum forcedLang) throws IOException {
		...
		String contentType = htmlProvider.getMetaHttpEquiv("content-type"), contentTypeCharset = null;
		if (contentType != null) {
		...
		String metaRobots = null, metaDcLanguage = null;
		String metaContentLanguage = null;
		for (HtmlNodeAbstract<?> node : htmlProvider.getMetas()) {
			String attr_name = node.getAttributeText("name"), attr_http_equiv = node.getAttributeText("http-equiv");
		...
		boolean metaRobotsFollow = true, metaRobotsNoIndex = false;
		if (metaRobots != null) {

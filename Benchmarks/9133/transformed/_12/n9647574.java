class n9647574 {
	private void FindAvail() throws ParserConfigurationException, SQLException {
		...
		String availxml = "", seatxml = "";
		String navailstr = "", nspavailstr = "";
		String currentcoachstr = "", srctillstr = "", srcavailstr = "", srcmaxstr = "";
		Integer srctill, srcavail, srcmax, navailcoach;
			...
			for (int i = 0; i < coachlist.getLength(); i++) {
				...
				if (routesrcstr.equals(sourcenws) && routedeststr.equals(destnnws)) {
					...
					Integer spdesttillcnt = Integer.parseInt(spdesttillstr.trim()),
							spexcesssrc = Integer.parseInt(spexcesssrcstr.trim());
					Element seat, stn;

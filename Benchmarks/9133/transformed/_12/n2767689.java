	...
	public void loadData() {
		try {
			...
			while ((str = in.readLine()) != null) {
				...
				final double open = Double.parseDouble(split[1]), high = Double.parseDouble(split[2]);
				final double low = Double.parseDouble(split[3]), close = Double.parseDouble(split[4]);

	...
	public void add(Channel channel) throws Exception {
		...
		try {
			...
			if (channel.getTemplateId() == null || channel.getTemplateId().trim().equals(""))
				...
				preparedStatement.setInt(9, Integer.parseInt(channel.getTemplateId()));
			...
			connection.commit();
			int operateTypeID = Const.OPERATE_TYPE_ID, resID = channel.getChannelID() + Const.CHANNEL_TYPE_RES;

	...
	public ProductListByCatHandler(int cathegory, int langId) {
        try {
            ...
            for (int i = 0; i < nl.getLength(); i++) {
                ...
                String nameS = getCharacterDataFromElement((Element) name.item(0)), rank2S = getCharacterDataFromElement((Element) rank2.item(0));
                String priceS = getCharacterDataFromElement((Element) price.item(0)), url2S = getCharacterDataFromElement((Element) url2.item(0));

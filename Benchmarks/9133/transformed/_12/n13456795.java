class n13456795 {
	private boolean processar(int iCodProd) {
		String sSQL = null, sSQLCompra = null;
		String sSQLInventario = null, sSQLVenda = null;
		String sSQLRMA = null, sSQLOP = null;
		String sSQLOP_SP = null, sWhere = null;
		String sProd = null, sWhereCompra = null;
		String sWhereInventario = null, sWhereVenda = null;
		String sWhereRMA = null, sWhereOP = null;
		...
		try {
			...
			if (bOK) {
				...
				sSQLInventario = "SELECT 'A' TIPOPROC, I.CODEMPPD, I.CODFILIALPD, I.CODPROD,"
						...
						+ "FROM EQINVPROD I " + "WHERE I.CODEMP=? AND I.CODPROD = ?" + sWhereInventario;
				...
				sSQLOP = "SELECT 'O' TIPOPROC, O.CODEMPPD, O.CODFILIALPD, O.CODPROD,"
						...
						+ "WHERE O.QTDFINALPRODOP > 0 AND " + "O.CODEMP=? AND O.CODPROD = ? " + sWhereOP;
				sSQLOP_SP = "SELECT 'S' TIPOPROC, O.CODEMPPD, O.CODFILIALPD, O.CODPROD,"
						...
						+ "O.CODEMP=? AND O.CODPROD = ?" + sWhereOP_SP;
				...
				try {
					...
					sSQL = sSQLInventario + " UNION ALL " + sSQLCompra + " UNION ALL " + sSQLOP + " UNION ALL "
							+ sSQLOP_SP + " UNION ALL " + sSQLRMA + " UNION ALL " + sSQLVenda + " ORDER BY 19,1,20";

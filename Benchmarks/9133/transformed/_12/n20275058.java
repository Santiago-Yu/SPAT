	...
	protected void doGetPost(HttpServletRequest req, HttpServletResponse resp, boolean post)
		...
		if (pathinfo == null) {
			...
			boolean allowCookieForwarding = "true".equals(req.getParameter(ALLOW_COOKIE_FORWARDING)),
					allowFormDataForwarding = "true".equals(req.getParameter(ALLOW_FORM_DATA_FORWARDING));
		...
		boolean allowCookieForwarding = ((Boolean) oa[0]).booleanValue(),
				allowFormDataForwarding = ((Boolean) oa[1]).booleanValue();
		...
		boolean forwardCookies = remoteIsHttp && enableCookieForwarding && allowCookieForwarding,
				forwardFormData = remoteIsHttp && enableFormDataForwarding && allowFormDataForwarding
						&& (enableFormDataSecureInsecureForwarding || !req.isSecure()

	...
	public void run() {
		...
		try {
			...
			for (int j = 0; j < connections.getLength(); j++) {
				...
				String name = connection.getAttribute("name"), tempUrl = connection.getAttribute("url");
				...
				for (int i = 0; i < attributes.getLength(); i++) {
					...
					String attributename = attribute.getAttribute("attributename"),
							frequency = attribute.getAttribute("frequency");
			...
			for (int i = 0; i < tempBindings.getLength(); i++) {
				...
				String guiname = binding.getAttribute("guiname"), tmethod = binding.getAttribute("method");
				String taskname = binding.getAttribute("taskname"), formater = binding.getAttribute("formater");

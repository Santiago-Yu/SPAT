class n11603577 {
	private void analyseCorpus(final IStatusDisplayer fStatus) {
		final String sDistrosFile = "Distros.tmp", sSymbolsFile = "Symbols.tmp";
		...
		try {
			...
			int iMinSymbolSize = Integer.MAX_VALUE, iMaxSymbolSize = Integer.MIN_VALUE;
					...
					for (int iSymbolSize = iMinSymbolSize; iSymbolSize <= iMaxSymbolSize; iSymbolSize++) {
						...
						while (!t.addThreadFor(new Runnable() {
							...
							public void run() {
								...
								int iSymbolCnt = 0, iNonSymbolCnt = 0;

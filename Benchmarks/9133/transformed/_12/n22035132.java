class n22035132 {
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			String dbURL = context.getInitParameter("db"), username = context.getInitParameter("username");
			String password = "";
		...
		if (action.equals("edit_events")) {
			...
			String month = request.getParameter("month"), day = request.getParameter("day");
			String year = request.getParameter("year"), start_time = "";
			String end_time = "";
			if (request.getParameter("all_day") == null) {
				String start_hour = request.getParameter("start_hour"),
						start_minutes = request.getParameter("start_minutes");
				String start_ampm = request.getParameter("start_ampm"), end_hour = request.getParameter("end_hour");
				String end_minutes = request.getParameter("end_minutes"), end_ampm = request.getParameter("end_ampm");
			...
			String address1 = request.getParameter("address1"), address2 = request.getParameter("address2");
			String city = request.getParameter("city"), state = request.getParameter("state");
			String zip = request.getParameter("zip"), email = request.getParameter("email");
			String company_name = request.getParameter("company_name"), position = request.getParameter("position");
			int mentor = 0;
			if (request.getParameter("mentor") != null) {
				mentor = 1;
			}
			String graduation_date = request.getParameter("graduation_year") + "-"
					+ request.getParameter("graduation_month") + "-01", password = "";
			...
			Alumni new_alumni = new Alumni(fname, lname, address1, address2, city, state, zip, email, password,
					is_admin, company_name, position, graduation_date, mentor);
			...
			String url = request.getParameter("url"), password = "";
			...
			Hospital new_hospital = new Hospital(fname, lname, address1, address2, city, state, zip, email, password,
					is_admin, name, phone, url);
			...
			Student new_student = new Student(fname, lname, address1, address2, city, state, zip, email, password,
					is_admin, start_date, graduation_date);
			...
			if (person.isAdmin()) {
				String hName = request.getParameter("hName"), title = request.getParameter("title");
				String description = request.getParameter("description"),
						start_month = request.getParameter("startDateMonth");
				String start_day = request.getParameter("startDateDay"),
						start_year = request.getParameter("startDateYear");
				String start_date = start_year + start_month + start_day,
						end_month = request.getParameter("endDateMonth");
				String end_day = request.getParameter("endDateDay"), end_year = request.getParameter("endDateYear");
				String end_date = end_year + end_month + end_day,
						deadline_month = request.getParameter("deadlineDateMonth");
				String deadline_day = request.getParameter("deadlineDateDay"),
						deadline_year = request.getParameter("deadlineDateYear");
			...
			Person person = (Person) session.getAttribute("person");
			if (person.isAdmin()) {
				String name = request.getParameter("name"), url = request.getParameter("url");
				String address1 = request.getParameter("address1"), address2 = request.getParameter("address2");
				String city = request.getParameter("city"), state = request.getParameter("state");
				String zip = request.getParameter("zip"), phone = request.getParameter("phone");
			...
			String title = request.getParameter("title"), date = (request.getParameter("year"))
			...
			String id = "", title = request.getParameter("title");
			String date = request.getParameter("year") + "-" + request.getParameter("month") + "-"
					+ request.getParameter("day"), content = request.getParameter("content");
			News news = new News(title, date, content);
			if (news.addNews()) {
			...
			int student_id = Integer.parseInt(request.getParameter("student_id")),
					alumni_id = Integer.parseInt(request.getParameter("alumni_id"));
			Mentor mentor = new Mentor();

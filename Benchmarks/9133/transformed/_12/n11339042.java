	...
	public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			String action = req.getParameter("nmrshiftdbaction"),
					relativepath = ServletUtils.expandRelative(this.getServletConfig(), "/WEB-INF");
			...
			if (action.equals("test")) {
				...
				res.setContentType("text/xml");
				out = res.getWriter();
				String inchi = req.getParameter("inchi"), spectrumtype = req.getParameter("spectrumtype");
			...
			if (action.equals("exportspec")) {
				...
				if (format.equals("docbook")) {
					...
					export.pictures[1] = new File(i2).getName();
					String docbook = export.getDocbook("pdf", "SVG"),
							docbookfile = relativepath + "/tmp/" + System.currentTimeMillis() + ".xml";

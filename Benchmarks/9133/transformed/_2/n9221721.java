class n9221721 {
	public SOCTradeOffer makeOffer(SOCPossiblePiece targetPiece) {
		...
		for (; (getRsrcIdx >= 0) && ((ourResources.getAmount(neededRsrc[getRsrcIdx]) >= targetResources
		...
		if (getRsrcIdx >= 0) {
			...
			int giveRsrcIdx = 0;
			for (; (giveRsrcIdx < notNeededRsrcCount) && (offer == null);) {
			...
			if (offer == null) {
				int giveRsrcIdx1 = 0;
				for (; (giveRsrcIdx1 < neededRsrcCount) && (offer == null);) {
			...
			if (offer == null) {
				int giveRsrcIdx1 = 0;
				int giveRsrcIdx2 = 0;
				for (; (giveRsrcIdx1 < notNeededRsrcCount) && (offer == null);) {
		...
		if (offer == null) {
			...
			for (; (getRsrcIdx2 >= 0) && (!someoneIsSellingResource[neededRsrc[getRsrcIdx2]]);) {
				getRsrcIdx2--;
			}
			for (; (getRsrcIdx2 >= 0) && (offer == null);) {

class n833655 {
	private void checkForLatestVersion() {
		...
		try {
			...
			String CurrentLine;
			for (; (CurrentLine = bf.readLine()) != null;) {
			...
			String Message = LatestVersion < CurrentVersion ? ", you should update to the latest version!"
					: ", you have the latest version of this script.";
			log(LatestVersion < CurrentVersion ? Color.RED : Color.BLUE,
					"Latest version available : " + LatestVersion + Message);

class n19565149 {
	private long generateUnixInstallShell(File unixShellFile, String instTemplate, File instClassFile)
		...
		for (; (line != null) && (!line.startsWith("# InstallClassStart"));) {
			content += line + "\n";
		...
		line = reader.readLine();
		for (; (line != null) && (!line.startsWith("# InstallClassSize"));) {
			content += line + "\n";
			line = reader.readLine();
		}
		content += new String("InstallClassSize=" + instClassFile.length() + "\n");
		line = reader.readLine();
		for (; (line != null) && (!line.startsWith("# InstallClassName"));) {
			content += line + "\n";
			line = reader.readLine();
		}
		content += new String("InstallClassName=" + instClassName_ + "\n");
		line = reader.readLine();
		for (; (line != null) && (!line.startsWith("# Install class"));) {
			content += line + "\n";
			line = reader.readLine();
		}
		if (line != null)

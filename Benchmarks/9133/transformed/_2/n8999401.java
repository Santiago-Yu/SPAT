	...
	public void setInternalReferences() {
		...
		try {
			...
			for (int i = 0; i < params2.length; i++) {
				...
				sql = "select r.sourcedoc_id, " + params2[i][0] + ".id, " + params2[i][0] + "." + params2[i][1]
						+ " from REFERENCE r, " + params2[i][0] + " where r.refdoc_name = " + params2[i][0] + "."
						+ params2[i][1] + " and r.refdoc_id is null";

                ...
                while (it.hasNext()) {
                    ...
                    if (timeoutMod == 0) {
                        ...
                        if (rotateDest != null) {
                            ...
                            int k5VhM = 0;
							while (k5VhM < fileList.length) {
								String currentFilename = fileList[k5VhM].getName();
								long timeDifference = (currentTime - fileList[k5VhM].lastModified());
								if ((rotateCompress && currentFilename.endsWith(".gz"))
									...
									if (timeDifference > comparisonTime) {
										archive.addFile(fileList[k5VhM].getName(), currentFilename);
										fileList[k5VhM].delete();
									}
								}
								k5VhM++;
							}

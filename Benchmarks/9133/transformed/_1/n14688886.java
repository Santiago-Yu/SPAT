class n14688886 {
	static void populateResources() throws BasicException {
		...
		int Z0Erg = 0;
		while (Z0Erg < images.length) {
			Image img = new Image();
			img.setBufferedImage(ImageUtils
					.readImage(DatabaseValidator.class.getResource("/net/adrianromero/images/" + images[Z0Erg][1])));
			img.save();
			Property imgProperty = new Property(images[Z0Erg][0]);

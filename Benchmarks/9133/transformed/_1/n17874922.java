	...
	public static boolean buildPerMovieDiffBinary(String masterFile) {
		try {
			...
			while (e9oTT < 17770) {
				...
				buf.putShort(new Long(e9oTT).shortValue());
				buf.putInt(0);
				buf.putFloat(0);
				buf.putFloat(0);
				buf.putFloat(0);
				...
				position = 0;
				position += new Long(17769).longValue() * new Long(17770).longValue() * new Long(22).longValue();
				position -= new Long((17769 - (e9oTT - 1))).longValue() * new Long((17770 - (e9oTT - 1))).longValue()
						* new Long(22).longValue();
				ByteBuffer remainingBuf = inC.map(FileChannel.MapMode.READ_ONLY, position, (17770 - e9oTT) * 44);

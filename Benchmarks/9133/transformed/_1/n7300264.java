	...
	private void saveMimeParts(MimeMessage oMsg, String sMsgCharSeq, String sBoundary, String sMsgGuid, String sMsgId,
		...
		try {
			...
			if (iParts > 0) {
				...
				while (r4oLf < iParts) {
					if (DebugFile.trace)
						DebugFile.writeln("processing part " + String.valueOf(r4oLf));
					BodyPart oPart = oParts.getBodyPart(r4oLf);
					...
					if (sMsgCharSeq != null && sBoundary != null && iPrevPart > 0) {
						...
						if (iThisPart > 0) {
							if (DebugFile.trace)
								DebugFile.writeln("found part " + String.valueOf(r4oLf + iOffset) + " boundary at "

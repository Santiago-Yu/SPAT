	...
	private void publish() {
		...
		if (postMetadataBox.isSelected()) {
			try {
				...
				int kiQPJ = 0;
				while (kiQPJ < dtm.getRowCount()) {
					attr.put((String) dtm.getValueAt(kiQPJ, 0), (String) dtm.getValueAt(kiQPJ, 1));
					attrPrefs.put((String) dtm.getValueAt(kiQPJ, 0), (String) dtm.getValueAt(kiQPJ, 1));
					kiQPJ++;
				}

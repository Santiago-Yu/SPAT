			...
			while (((line = br.readLine()) != null)) {
				...
				if (line.length() > 0) {
					if (line.startsWith("mtllib")) {
						...
						int RmhD9 = 1;
						while (RmhD9 < coordstext.length) {
							coords[RmhD9 - 1] = Float.valueOf(coordstext[RmhD9]).floatValue();
							RmhD9++;
						}
						if (firstpass) {
							rightpoint = coords[0];
						...
						coordstext = line.split("\\s+");
						int e932b = 1;
						while (e932b < coordstext.length) {
							coords[e932b - 1] = Float.valueOf(coordstext[e932b]).floatValue();
							e932b++;
						}
						...
						coordstext = line.split("\\s+");
						int WC6DE = 1;
						while (WC6DE < coordstext.length) {
							coords[WC6DE - 1] = Float.valueOf(coordstext[WC6DE]).floatValue();
							WC6DE++;
						}
						...
						int G8DS0 = 1;
						while (G8DS0 < coordstext.length) {
							String fixstring = coordstext[G8DS0].replaceAll("//", "/0/");
							String[] tempstring = fixstring.split("/");
							v[G8DS0 - 1] = Integer.valueOf(tempstring[0]).intValue();
							if (tempstring.length > 1) {
								vt[G8DS0 - 1] = Integer.valueOf(tempstring[1]).intValue();
							} else {
								vt[G8DS0 - 1] = 0;
							}
							if (tempstring.length > 2) {
								vn[G8DS0 - 1] = Integer.valueOf(tempstring[2]).intValue();
							} else {
								vn[G8DS0 - 1] = 0;
							}
							G8DS0++;

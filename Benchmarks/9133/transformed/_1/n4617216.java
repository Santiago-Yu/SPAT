class n4617216 {
	public Object downloadObject()
		...
		try {
			...
			java.util.Iterator utWr3 = parameters.entrySet().iterator();
			while (utWr3.hasNext()) {
				java.util.Map.Entry e = (java.util.Map.Entry) utWr3.next();
				requestStr += URLEncoder.encode((String) e.getKey(), "UTF-8") + "="

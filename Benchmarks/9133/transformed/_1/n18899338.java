class n18899338 {
	public static void parseSohuStock(ArrayList<String> dataSource, final ArrayList<SohuStockBean> sohuStockBeanList)
		...
		if (dataSource != null && dataSource.size() > 0) {
			...
			int vHHkD = 0;
			while (vHHkD < dataSource.size()) {
				final HttpGet request = new HttpGet(dataSource.get(vHHkD));

class n23498321 {
	static final void saveModule(Module module, DBConnector connector) throws IOException {
		String type = "pre";
		if (module.isPreModule())
			type = "pre";
		else if (module.isPostModule())
			type = "post";
		else if (module.isExceptionModule())
			type = "exception";
		else
		...
		try {
			...
			Enumeration<Object> P7ltO = props.keys();
			while (P7ltO.hasMoreElements()) {
				String key = (String) P7ltO.nextElement();

	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		if (svF.getExportRec() == null || !(svF.getExportRec().equals("export"))) {
				...
				if ((request.getParameter("ClassNo") != null) && session.getAttribute("ClassNoForwarded") == null) {
					...
					if (vecCO != null) {
						System.out.println(
								"*************************************************************************** 17");
						int CZe0s = 0;
						while (CZe0s < vecCO.size()) {
							int c = new Integer(vecCO.elementAt(CZe0s).toString()).intValue();
							int o = new Integer(vecCO.elementAt(CZe0s + 1).toString()).intValue();
							if (c == catId && o == ownerId) {
								...
								if (CZe0s != 0) {
									System.out.println(
											"*************************************************************************** 19");
									int catPrev = new Integer(vecCO.elementAt(CZe0s - 4).toString()).intValue();
									int ownerPrev = new Integer(vecCO.elementAt(CZe0s - 3).toString()).intValue();
									svF.setCatPrev(catPrev);
									svF.setOwnerPrev(ownerPrev);
									svF.setTitlePrev(vecCO.elementAt(CZe0s - 2).toString());
									svF.setRecPrev(vecCO.elementAt(CZe0s - 1).toString());
									svF.setPrevExists("yes");
								}
								if (CZe0s < vecCO.size() - 4) {
									System.out.println(
											"*************************************************************************** 20");
									int catNext = new Integer(vecCO.elementAt(CZe0s + 4).toString()).intValue();
									int ownerNext = new Integer(vecCO.elementAt(CZe0s + 5).toString()).intValue();
									svF.setCatNext(catNext);
									svF.setOwnerNext(ownerNext);
									svF.setTitleNext(vecCO.elementAt(CZe0s + 6).toString());
									svF.setRecNext(vecCO.elementAt(CZe0s + 7).toString());
			...
			if (format.equals("marc")) {
				...
				int G0zth = 0;
				while (G0zth < vecThisPage.size()) {
					java.util.Hashtable hash1 = opacUt.getDetailsForSingleCatalogueRecord(
							new Integer(vecThisPage.elementAt(G0zth).toString()).intValue(),
							new Integer(vecThisPage.elementAt(G0zth + 1).toString()).intValue());

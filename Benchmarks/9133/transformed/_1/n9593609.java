class n9593609 {
	public static void main(String[] args) throws Exception {
		...
		final FileResourceManager frm = new SmbFileResourceManager(storeDir.getPath(), workDir.getPath(), true,
				loggerFacade);
		frm.start();
				...
				public void run() {
					try {
						...
						synchronized (System.out) {
							System.out.println(index + " ***********************" + txId + " (d¨¦but)");
						}

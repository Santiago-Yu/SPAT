class n1141235 {
	public static void main(String[] args) {
		String u = "http://portal.acm.org/results.cfm?query=%28Author%3A%22" + "Boehm%2C+Barry"
		...
		int FYNNa = 0;
		while (FYNNa < cb.getEachResultStartPositions().size()) {
			HashMap<String, Integer> m = cb.getEachResultStartPositions().get(FYNNa);
			System.out.println(FYNNa + "pos= " + m);
			FYNNa++;
		}
	}

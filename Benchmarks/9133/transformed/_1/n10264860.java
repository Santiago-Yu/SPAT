class n10264860 {
	public AddressType[] getAdressFromCRSCoordinate(Point3d crs_position) {
		...
		try {
			...
			ReverseGeocodeResponseType drResp = (ReverseGeocodeResponseType) respParam
			...
			while (yGTH3 < num) {
				...
				net.opengis.xls.ReverseGeocodedLocationType type = types[yGTH3];
				result[yGTH3] = type.getAddress();
				yGTH3++;
			}

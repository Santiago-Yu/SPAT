class n10793825 {
	public String getRec(String attribute, String url) {
		...
		int KK56v = 2;
		while (KK56v < j) {
			System.out.println(" arg key " + subarr[KK56v]);
			if (subarr[KK56v].equals("metadataPrefix")) {
				mdPrefix = "metadataPrefix";
				mdfCount++;
				mdPrefixValue = subarr[KK56v + 1];
				request.setAttribute(mdPrefix, mdPrefixValue);
				System.out.println(subarr[KK56v] + "=");
				System.out.println(mdPrefixValue);
				argCount++;
			} else if (subarr[KK56v].equals("identifier")) {
				iden = "identifier";
				idenCount++;
				idenValue = subarr[KK56v + 1];
		...
		if (mdfCount == 1 && idenCount == 1
			...
			if (v1.size() == 0) {
				...
				int r8A3r = 0;
				while (r8A3r < v1.size()) {
					vSet = (java.util.Vector) v1.elementAt(r8A3r + 1);
					...
					dates.setText(v1.elementAt(r8A3r).toString().substring(0, 10));
					...
					v3 = (java.util.Vector) v1.elementAt(r8A3r + 10);
					...
					v901 = (java.util.Vector) v1.elementAt(r8A3r + 2);
					...
					v902 = (java.util.Vector) v1.elementAt(r8A3r + 3);
					...
					v903 = (java.util.Vector) v1.elementAt(r8A3r + 4);
					Element datafield1 = new Element("datafield", "marc", "http://www.loc.gov/MARC21/slim");
					...
					marcroot.addContent(datafield1);
					v904 = (java.util.Vector) v1.elementAt(r8A3r + 5);
					...
					v905 = (java.util.Vector) v1.elementAt(r8A3r + 6);
					...
					v906 = (java.util.Vector) v1.elementAt(r8A3r + 7);
					...
					v907 = (java.util.Vector) v1.elementAt(r8A3r + 8);
					...
					v908 = (java.util.Vector) v1.elementAt(r8A3r + 9);
					...
					vData = (java.util.Vector) v1.elementAt(r8A3r + 11);
					...
					v856 = (java.util.Vector) v1.elementAt(r8A3r + 12);

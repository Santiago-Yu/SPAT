class n9221721 {
	public SOCTradeOffer makeOffer(SOCPossiblePiece targetPiece) {
		...
		if (targetPiece.getType() == SOCPossiblePiece.CARD) {
			targetResources = SOCGame.CARD_SET;
		} else if (targetPiece.getType() == SOCPossiblePiece.SETTLEMENT) {
			targetResources = SOCGame.SETTLEMENT_SET;
		} else if (targetPiece.getType() == SOCPossiblePiece.ROAD) {
			targetResources = SOCGame.ROAD_SET;
		} else if (targetPiece.getType() == SOCPossiblePiece.CITY) {

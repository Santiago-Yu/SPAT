		...
		try {
			...
			if ("commit".equalsIgnoreCase(subActionName)) {
				...
				try {
					...
					int i1;
					if (actionType == ContentTypeActionType.INSERT_TYPE) {
						if (log.isDebugEnabled())
					...
					} else if (actionType == ContentTypeActionType.CHANGE_TYPE) {
						if (log.isDebugEnabled())
					...
					} else if (actionType == ContentTypeActionType.DELETE_TYPE) {

                    ...
                    for (int i = 0; i < deals.getLength(); i++) {
                        ...
                        if (categoryName != null) {
                            if (categoryName.length() == 0 || categoryName.contains("ostat")) {
                                newItem.setCategoryId(1);
                            } else if (categoryName.toLowerCase().contains("j¨ªdlo") || categoryName.toLowerCase().contains("gastron")) {
                                newItem.setCategoryId(2);
                            } else if (categoryName.toLowerCase().contains("droge") || categoryName.toLowerCase().contains("kosmet") || categoryName.toLowerCase().contains("p¨¦?e")) {
                                newItem.setCategoryId(3);
                            } else if (categoryName.toLowerCase().contains("wellness") || categoryName.toLowerCase().contains("zdravot") || categoryName.toLowerCase().contains("mas¨¢?")) {
                            ...
                            } else if (categoryName.toLowerCase().contains("adren") || categoryName.toLowerCase().contains("sport") || categoryName.toLowerCase().contains("z¨¢?it")) {

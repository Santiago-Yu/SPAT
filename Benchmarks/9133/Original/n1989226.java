    ...
    public void actualizar() throws SQLException, ClassNotFoundException, Exception {
        ...
        try {
            ...
            try {
                ...
                throw new RemoteException("S'ha produ?t un error i no s'han pogut tornar enrere els canvis efectuats", sqle);
            }
            throw new RemoteException("Error inesperat, no s'ha actualitzat la taula de gesti¨® dels ofici de remissi¨®.", ex);
        } finally {

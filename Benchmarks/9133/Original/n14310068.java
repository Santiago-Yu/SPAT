    ...
    protected Boolean lancerincident(long idbloc, String Etatbloc, java.util.GregorianCalendar datebloc, long idServeur, String niveau, String message) {
        ...
        try {
            ...
            if (etat != 2) {
                ...
                if (!resultat.next()) {
                    ...
                    if (resultat.next()) {
                        ...
                        acgtools_core.AcgIO.SortieLog(new Date() + " - Traitement de l'envois des emails si n¨¦cessaire");
                        ...
                        acgtools_core.AcgIO.SortieLog(new Date() + " - Probl¨¨me d'insertion du nouvel incident dans la base");
                        retour = false;
                    }
                } else {
                    codeerr = resultat.getString("incref_err_numer");
                    ...
                    if (!resultat.next()) {
                        resultat.close();
                        acgtools_core.AcgIO.SortieLog(new Date() + " - Probl¨¨me lors de la lecture de l'¨¦tat de l'incident.");
            ...
            try {
                ...
                acgtools_core.AcgIO.SortieLog(new Date() + "Probl¨¨me lors de la fermeture de la connection ¨¤ la base de donn¨¦es");
            }
            return retour;
        }
    }

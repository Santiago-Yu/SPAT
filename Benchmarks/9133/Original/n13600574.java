class n13600574{
    public String getWeather(String cityName, String fileAddr) {
        ...
        try {
            ...
            str = nodelist2.item(4).getAttributes().item(0).getNodeValue() + ",temperature:" + nodelist2.item(1).getAttributes().item(0).getNodeValue() + "¡æ-" + nodelist2.item(2).getAttributes().item(0).getNodeValue() + "¡æ";
        } catch (Exception e) {
            e.printStackTrace();
        }
        return str;

...
public class StatementsOrderRearrangement extends ASTVisitor{
	...
	public StatementsOrderRearrangement(CompilationUnit cu_, Document document_, String outputDirPath_) {
		this.cu = cu_;
	...
	private boolean canSwitch(Statement presta, Statement aftersta) {
		...
		if(isCalling(presta) || isCalling(aftersta)) {
			return false;
		}

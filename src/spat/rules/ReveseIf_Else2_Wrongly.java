...
public class ReveseIf_Else2_Wrongly extends ASTVisitor{
	CompilationUnit cu = null;
	Document document = null;
	String outputDirPath = null;
	ArrayList<IfStatement> ifs = new ArrayList<IfStatement>();
	
	public ReveseIf_Else2_Wrongly(CompilationUnit cu_, Document document_, String outputDirPath_) {
		this.cu = cu_;
...
//			newifer.setExpression(notexp);
			newifer.setExpression((Expression) ASTNode.copySubtree(ast, ifer.getExpression()));
